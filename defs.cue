// Package cuetf profides a schema for the output of
//		terraform providers schema -json
package cuetf

#ProviderSchema: {
	provider: #type // Provider configuration schema.
	resource_schemas: [string]:    #type // Resources definitions.
	data_source_schemas: [string]: #type // Data sources definitions.

	// TODO: Not supported by the CUE schemas generator. Used in the AWS provider.
	ephemeral_resource_schemas: [string]: #type
	// TODO: Not supported by the CUE schemas generator. Used in the Scaleway and Azure providers.
	action_schemas: [string]: #type
	// TODO: Not supported by the CUE schemas generator. Used in Azure provider.
	list_resource_schemas: [string]: #type
