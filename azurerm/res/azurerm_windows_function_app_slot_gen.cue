...
#azurerm_windows_function_app_slot: {
	...
	@jsonschema(id="https://github.com/roman-mazur/cuetf/schema/azurerm_windows_function_app_slot")
	close({
		...
		// The mode of the Function App Slot's client certificates
		// requirement for incoming requests. Possible values are
		...
		// The identifier used by App Service to perform domain ownership
		...
		// A list of outbound IP addresses. For example `["52.23.25.3",
		// "52.143.43.12"]`.
		outbound_ip_address_list?: [...string]

		// A comma separated list of outbound IP addresses as a string.
		// For example `52.23.25.3,52.143.43.12`.
		outbound_ip_addresses?: string

		// A list of possible outbound IP addresses, not all of which are
		// necessarily in use. This is a superset of
		...
		// Should the Function App Slot use its Managed Identity to access
		// storage?
	...
	#site_config: close({
		...
		// between `2` and `10`. Defaults to `10`. Only valid in
		// conjunction with `health_check_path`
