...
#azurerm_kubernetes_flux_configuration: {
	...
	#blob_storage: close({
		managed_identity?: matchN(1, [_#defs."/$defs/blob_storage/$defs/managed_identity", list.MaxItems(1) & [..._#defs."/$defs/blob_storage/$defs/managed_identity"]])
		account_key?:              string
		container_id!:             string
	...
	#kustomizations: close({
		post_build?: matchN(1, [_#defs."/$defs/kustomizations/$defs/post_build", list.MaxItems(1) & [..._#defs."/$defs/kustomizations/$defs/post_build"]])
		depends_on?: [...string]
	...
	_#defs: "/$defs/blob_storage/$defs/managed_identity": close({
		client_id!: string
	})
	...
	_#defs: "/$defs/kustomizations/$defs/post_build": close({
		substitute_from?: matchN(1, [_#defs."/$defs/kustomizations/$defs/post_build/$defs/substitute_from", [..._#defs."/$defs/kustomizations/$defs/post_build/$defs/substitute_from"]])
		substitute?: [string]: string
	})

	_#defs: "/$defs/kustomizations/$defs/post_build/$defs/substitute_from": close({
		kind!:     string
		name!:     string
		optional?: bool
	})
