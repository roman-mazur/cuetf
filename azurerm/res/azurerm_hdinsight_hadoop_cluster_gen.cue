...
#azurerm_hdinsight_hadoop_cluster: {
	...
	#roles: close({
		edge_node?: matchN(1, [_#defs."/$defs/roles/$defs/edge_node", list.MaxItems(1) & [..._#defs."/$defs/roles/$defs/edge_node"]])
	...
	_#defs: "/$defs/roles/$defs/edge_node": close({
		https_endpoints?: matchN(1, [_#defs."/$defs/roles/$defs/edge_node/$defs/https_endpoints", [..._#defs."/$defs/roles/$defs/edge_node/$defs/https_endpoints"]])
		install_script_action!: matchN(1, [_#defs."/$defs/roles/$defs/edge_node/$defs/install_script_action", [_, ...] & [..._#defs."/$defs/roles/$defs/edge_node/$defs/install_script_action"]])
		uninstall_script_actions?: matchN(1, [_#defs."/$defs/roles/$defs/edge_node/$defs/uninstall_script_actions", [..._#defs."/$defs/roles/$defs/edge_node/$defs/uninstall_script_actions"]])
		target_instance_count!: number
		vm_size!:               string
	})

	_#defs: "/$defs/roles/$defs/edge_node/$defs/https_endpoints": close({
		access_modes?: [...string]
	...
	_#defs: "/$defs/roles/$defs/edge_node/$defs/install_script_action": close({
		name!:       string
		parameters?: string
		uri!:        string
	})

	_#defs: "/$defs/roles/$defs/edge_node/$defs/uninstall_script_actions": close({
		name!:       string
		parameters?: string
		uri!:        string
	})
	...
	_#defs: "/$defs/roles/$defs/worker_node/$defs/autoscale": close({
		capacity?: matchN(1, [_#defs."/$defs/roles/$defs/worker_node/$defs/autoscale/$defs/capacity", list.MaxItems(1) & [..._#defs."/$defs/roles/$defs/worker_node/$defs/autoscale/$defs/capacity"]])
	...
	_#defs: "/$defs/roles/$defs/worker_node/$defs/autoscale/$defs/capacity": close({
