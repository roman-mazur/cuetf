...
#azurerm_hdinsight_kafka_cluster: {
	...
	_#defs: "/$defs/roles/$defs/kafka_management_node": close({
		script_actions?: matchN(1, [_#defs."/$defs/roles/$defs/kafka_management_node/$defs/script_actions", [..._#defs."/$defs/roles/$defs/kafka_management_node/$defs/script_actions"]])
		password?: string
		ssh_keys?: [...string]
		subnet_id?:          string
		username?:           string
	...
	_#defs: "/$defs/roles/$defs/kafka_management_node/$defs/script_actions": close({
		name!:       string
		parameters?: string
		uri!:        string
	})
