...
#cloudflare_zero_trust_dns_location: {
	...
	close({
		...
		// location. When creating a location, if this field is absent or
		// set with null, the pair of shared IPv4 addresses
		// (0e4a32c6-6fb8-4858-9296-98f51631e8e6) is auto-assigned. When
		// updating a location, if the field is absent or set with null,
