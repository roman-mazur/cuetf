...
_ds: cloudflare_api_token_permission_groups: data.#cloudflare_api_token_permission_groups
_ds: cloudflare_dcv_delegation: data.#cloudflare_dcv_delegation
_ds: cloudflare_device_posture_rules: data.#cloudflare_device_posture_rules
_ds: cloudflare_devices: data.#cloudflare_devices
_ds: cloudflare_dlp_datasets: data.#cloudflare_dlp_datasets
...
_ds: cloudflare_origin_ca_root_certificate: data.#cloudflare_origin_ca_root_certificate
_ds: cloudflare_record: data.#cloudflare_record
_ds: cloudflare_tunnel: data.#cloudflare_tunnel
_ds: cloudflare_tunnel_virtual_network: data.#cloudflare_tunnel_virtual_network
...
_ds: cloudflare_zero_trust_tunnel_virtual_network: data.#cloudflare_zero_trust_tunnel_virtual_network
