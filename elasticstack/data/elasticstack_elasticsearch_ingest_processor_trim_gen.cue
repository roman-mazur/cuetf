package data
	...
	@jsonschema(id="https://github.com/roman-mazur/cuetf/schema/data/elasticstack_elasticsearch_ingest_processor_trim")
	close({
		...
		// The field to assign the trimmed value to, by default `field` is
		// updated in-place.
		target_field?: string
	})
}
