...
#google_scc_organization_custom_module: {
	...
	@jsonschema(id="https://github.com/roman-mazur/cuetf/schema/res/google_scc_organization_custom_module")
	close({
		...
		// "organizations/{org_id}/securityHealthAnalyticsSettings/customModules/{customModule}".
		// The id {customModule} is server-generated and is not user
		// settable. It will be a numeric id containing 1-20 digits.
		name?: string
		custom_config!: matchN(1, [#custom_config, list.MaxItems(1) & [_, ...] & [...#custom_config]])
		timeouts?: #timeouts
