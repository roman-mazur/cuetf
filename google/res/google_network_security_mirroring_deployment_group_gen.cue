...
#google_network_security_mirroring_deployment_group: {
	...
	@jsonschema(id="https://github.com/roman-mazur/cuetf/schema/res/google_network_security_mirroring_deployment_group")
	close({
		...
		// The network that will be used for all child deployments, for
		// example:
