...
#google_gkeonprem_bare_metal_cluster: {
	...
	_#defs: "/$defs/load_balancer/$defs/metal_lb_config/$defs/load_balancer_node_pool_config": close({
		node_pool_config?: matchN(1, [_#defs."/$defs/load_balancer/$defs/metal_lb_config/$defs/load_balancer_node_pool_config/$defs/node_pool_config", list.MaxItems(1) & [..._#defs."/$defs/load_balancer/$defs/metal_lb_config/$defs/load_balancer_node_pool_config/$defs/node_pool_config"]])
	})

	_#defs: "/$defs/load_balancer/$defs/metal_lb_config/$defs/load_balancer_node_pool_config/$defs/node_pool_config": close({
		node_configs?: matchN(1, [_#defs."/$defs/load_balancer/$defs/metal_lb_config/$defs/load_balancer_node_pool_config/$defs/node_pool_config/$defs/node_configs", [..._#defs."/$defs/load_balancer/$defs/metal_lb_config/$defs/load_balancer_node_pool_config/$defs/node_pool_config/$defs/node_configs"]])
		taints?: matchN(1, [_#defs."/$defs/load_balancer/$defs/metal_lb_config/$defs/load_balancer_node_pool_config/$defs/node_pool_config/$defs/taints", [..._#defs."/$defs/load_balancer/$defs/metal_lb_config/$defs/load_balancer_node_pool_config/$defs/node_pool_config/$defs/taints"]])
	...
	_#defs: "/$defs/load_balancer/$defs/metal_lb_config/$defs/load_balancer_node_pool_config/$defs/node_pool_config/$defs/node_configs": close({
		// The map of Kubernetes labels (key/value pairs) to be applied to
		// each node. These will added in addition to any default label(s)
		// that Kubernetes may apply to the node. In case of conflict in
		// label keys, the applied set may differ depending on the
	...
	_#defs: "/$defs/network_config/$defs/sr_iov_config": close({
