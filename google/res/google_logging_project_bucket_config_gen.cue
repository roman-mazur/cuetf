...
#google_logging_project_bucket_config: {
	...
	@jsonschema(id="https://github.com/roman-mazur/cuetf/schema/google_logging_project_bucket_config")
	close({
		...
		// Whether the bucket is locked. The retention period on a locked
		// bucket cannot be changed. Locked buckets may only be deleted
		// if they are empty.
		locked?: bool
