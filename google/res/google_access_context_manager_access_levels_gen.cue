...
#google_access_context_manager_access_levels: {
	...
	_#defs: "/$defs/access_levels/$defs/basic/$defs/conditions/$defs/device_policy/$defs/os_constraints": close({
	...
	_#defs: "/$defs/access_levels/$defs/basic/$defs/conditions/$defs/vpc_network_sources": close({
		vpc_subnetwork?: matchN(1, [_#defs."/$defs/access_levels/$defs/basic/$defs/conditions/$defs/vpc_network_sources/$defs/vpc_subnetwork", list.MaxItems(1) & [..._#defs."/$defs/access_levels/$defs/basic/$defs/conditions/$defs/vpc_network_sources/$defs/vpc_subnetwork"]])
	})
