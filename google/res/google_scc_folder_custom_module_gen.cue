...
#google_scc_folder_custom_module: {
	...
	@jsonschema(id="https://github.com/roman-mazur/cuetf/schema/res/google_scc_folder_custom_module")
	close({
		...
		// "folders/{folder_id}/securityHealthAnalyticsSettings/customModules/{customModule}".
