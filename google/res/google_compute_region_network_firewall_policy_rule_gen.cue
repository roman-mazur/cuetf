...
#google_compute_region_network_firewall_policy_rule: {
	...
	@jsonschema(id="https://github.com/roman-mazur/cuetf/schema/res/google_compute_region_network_firewall_policy_rule")
	close({
		...
		//
		// Security Profile Group and Firewall Policy Rule must be in the
		// same scope.
