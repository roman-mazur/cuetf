...
#google_network_security_mirroring_deployment: {
	...
	@jsonschema(id="https://github.com/roman-mazur/cuetf/schema/res/google_network_security_mirroring_deployment")
	close({
		...
		// The regional forwarding rule that fronts the mirroring
		// collectors, for
		// example:
