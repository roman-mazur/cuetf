...
#google_cloud_run_v2_service: {
	...
	close({
		...
		// Settings for creating a Multi-Region Service. Make sure to use
		// region = 'global' when using them. For more information, visit
		...
		// provided, defaults to 100% traffic to the latest Ready
		// Revision.
		traffic?: [...close({
			percent?:  number
			revision?: string
