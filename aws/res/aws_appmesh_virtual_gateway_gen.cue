...
#aws_appmesh_virtual_gateway: {
	...
	@jsonschema(id="https://github.com/roman-mazur/cuetf/schema/res/aws_appmesh_virtual_gateway")
	close({
		arn?:               string
		created_date?:      string
		id?:                string
	...
	#spec: close({
		...
		listener!: matchN(1, [_#defs."/$defs/spec/$defs/listener", [_, ...] & [..._#defs."/$defs/spec/$defs/listener"]])
	...
	_#defs: "/$defs/spec/$defs/listener/$defs/connection_pool": close({
		...
		http?: matchN(1, [_#defs."/$defs/spec/$defs/listener/$defs/connection_pool/$defs/http", list.MaxItems(1) & [..._#defs."/$defs/spec/$defs/listener/$defs/connection_pool/$defs/http"]])
		http2?: matchN(1, [_#defs."/$defs/spec/$defs/listener/$defs/connection_pool/$defs/http2", list.MaxItems(1) & [..._#defs."/$defs/spec/$defs/listener/$defs/connection_pool/$defs/http2"]])
	})
