...
#provider: {
	...
	close({
		...
		// Enterprise without strict rate limits. Although, it is not
		// possible to enable this setting on github.com because we
		// enforce the respect of github.com's best practices to avoid
		// hitting abuse rate limitsDefaults to false if not set
