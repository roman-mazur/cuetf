...
google_alloydb_cluster: {
	...
	close({
		...
		//
		// If no policy is provided then the default policy will be used. The default
		// policy takes one backup a day and retains backups for 14 days.
		...
		// Configuration for Dataplex integration. This is an optional field. If not
		// set, Dataplex integration will be enabled by default.
		...
		// Initial user to setup during cluster creation. If unset for new Clusters, a
		// postgres role with null password is created. You will need to create
		// additional users or set the password in order to log in.
		initial_user?: [...close({
			password?:            string
			password_wo?:         string
		...
		// 'restore_continuous_backup_source', 'restore_backupdr_backup_source' and
		...
		// The source when restoring from a backup. Conflicts with
		// 'restore_continuous_backup_source', 'restore_backup_source' and
		// 'restore_backupdr_pitr_source', they can't be set together.
		restore_backupdr_backup_source?: [...close({
			backup?: string
		})]

		// The BackupDR source used for point in time recovery. Conflicts with
		// 'restore_backupdr_backup_source', 'restore_continuous_backup_source' and
		...
		// The source when restoring via point in time recovery (PITR). Conflicts with
		// 'restore_backup_source', 'restore_backupdr_backup_source' and
		// 'restore_backupdr_pitr_source', they can't be set together.
		...
		// Configuration of the secondary cluster for Cross Region Replication. This
