...
google_compute_region_target_https_proxy: {
	...
	@jsonschema(id="https://github.com/roman-mazur/cuetf/schema/data/google_compute_region_target_https_proxy")
	close({
		...
		// At least one SSL certificate must be specified. Currently, you may specify up
