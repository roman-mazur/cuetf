...
google_pubsub_subscription: {
	...
	@jsonschema(id="https://github.com/roman-mazur/cuetf/schema/data/google_pubsub_subscription")
	close({
		...
		// messages will be retried as soon as possible for healthy subscribers.
