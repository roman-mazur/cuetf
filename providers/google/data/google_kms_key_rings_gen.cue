...
google_kms_key_rings: {
	...
	@jsonschema(id="https://github.com/roman-mazur/cuetf/schema/data/google_kms_key_rings")
	close({
		...
		// Example values:
		//
		// * "name:my-key-" will retrieve key rings that contain "my-key-" anywhere in
		// their name. Note: names take the form
		// projects/{{project}}/locations/{{location}}/keyRings/{{keyRing}}.
		// * "name=projects/my-project/locations/global/keyRings/my-key-ring" will only
		// retrieve a key ring with that exact name.
		//
