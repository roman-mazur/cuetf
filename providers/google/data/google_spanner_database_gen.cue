...
google_spanner_database: {
	...
	@jsonschema(id="https://github.com/roman-mazur/cuetf/schema/data/google_spanner_database")
	close({
		// The dialect of the Cloud Spanner Database.
		// If it is not provided, "GOOGLE_STANDARD_SQL" will be used. Possible values:
		...
		// whereas setting “enableDropProtection” to true protects the database from
		// deletions in all interfaces.
		// (2) Setting "enableDropProtection" to true also prevents the deletion of the
		// parent instance containing the database.
		// "deletion_protection" attribute does not provide protection against the
		// deletion of the parent instance.
