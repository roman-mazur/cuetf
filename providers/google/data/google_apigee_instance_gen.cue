...
#google_apigee_instance: {
	...
	@jsonschema(id="https://github.com/roman-mazur/cuetf/schema/data/google_apigee_instance")
	close({
		// Access logging configuration enables the access logging feature
		// at the instance.
		// Apigee customers can enable access logging to ship the access
