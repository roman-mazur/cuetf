...
google_cloud_run_v2_service: {
	...
	@jsonschema(id="https://github.com/roman-mazur/cuetf/schema/data/google_cloud_run_v2_service")
	close({
		...
		// Settings for creating a Multi-Region Service. Make sure to use region =
		// 'global' when using them. For more information, visit
		// https://cloud.google.com/run/docs/multiple-regions#deploy
