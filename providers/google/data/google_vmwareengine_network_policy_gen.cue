...
google_vmwareengine_network_policy: {
	...
	@jsonschema(id="https://github.com/roman-mazur/cuetf/schema/data/google_vmwareengine_network_policy")
	close({
		...
		// prefixes either in the consumer VPC network or in use by the private clouds
