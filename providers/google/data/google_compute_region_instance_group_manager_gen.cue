...
google_compute_region_instance_group_manager: {
	...
	close({
		...
		// The flexibility policy for this managed instance group. Instance flexibility
		// allowing MIG to create VMs from multiple types of machines. Instance
		...
		// update, etc. Structure is documented below. For more information see the
		// official documentation. Proactive cross zone instance redistribution must be
		// disabled before you can update stateful disks on existing instance group
		// managers. This can be controlled via the update_policy.
		stateful_disk?: [...close({
			delete_rule?: string
			device_name?: string
		})]
		...
		// Application versions managed by this instance group. Each version deals with
		// a specific instance template, allowing canary release scenarios.
		version?: [...close({
