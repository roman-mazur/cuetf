...
google_compute_disk: {
	...
	@jsonschema(id="https://github.com/roman-mazur/cuetf/schema/data/google_compute_disk")
	close({
		...
		// Note: Updating currently is only supported by hyperdisk skus without the need
		// to delete and recreate the disk, hyperdisk
		// allows for an update of IOPS every 4 hours. To update your hyperdisk more
		...
		// Note: Updating currently is only supported by hyperdisk skus without the need
		// to delete and recreate the disk, hyperdisk
		// allows for an update of Throughput every 4 hours. To update your hyperdisk
		// more frequently, you'll need to manually delete and recreate it
