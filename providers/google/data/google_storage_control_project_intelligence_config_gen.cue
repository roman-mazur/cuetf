...
google_storage_control_project_intelligence_config: {
	...
	@jsonschema(id="https://github.com/roman-mazur/cuetf/schema/data/google_storage_control_project_intelligence_config")
	close({
		...
		// Filter over location and bucket using include or exclude semantics. Resources
		// that match the include or exclude filter are exclusively included or
		// excluded from the Storage Intelligence plan.
		filter?: [...close({
