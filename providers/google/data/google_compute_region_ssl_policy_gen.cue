...
#google_compute_region_ssl_policy: {
	...
	@jsonschema(id="https://github.com/roman-mazur/cuetf/schema/data/google_compute_region_ssl_policy")
	close({
		...
		// The
		// method returns the set of features that can be specified in
		// this
		...
		// the load balancer negotiates
		// X25519MLKEM768 key exchange when clients advertise support for
		// it.
