...
google_vertex_ai_index: {
	...
	close({
		...
		// Customer-managed encryption key spec for an Index. If set, this Index and all
		// sub-resources of this Index will be secured by this key.
		...
		// Although this field is not marked as required in the API specification, it is
		// currently required when creating an Index and must be provided.
