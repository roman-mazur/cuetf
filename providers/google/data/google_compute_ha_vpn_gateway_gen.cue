...
google_compute_ha_vpn_gateway: {
	...
	close({
		...
		// specified, IPV4 will be used. Default value: "IPV4" Possible values:
		// ["IPV4", "IPV6"]
		...
		// If not specified, IPV4_ONLY will be used. Default value: "IPV4_ONLY" Possible
		// values: ["IPV4_ONLY", "IPV4_IPV6", "IPV6_ONLY"]
		stack_type?: string
