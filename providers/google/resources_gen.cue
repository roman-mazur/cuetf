...
#Terraform: {
	...
	_#res: "\(#googlePrefix)_agent_identity_auth_provider": close({res.google_agent_identity_auth_provider & cuetf.MetaArgs})
	...
	_#res: "\(#googlePrefix)_agentic_applications_analyst_agent_persona": close({res.google_agentic_applications_analyst_agent_persona & cuetf.MetaArgs})
	...
	_#res: "\(#googlePrefix)_apihub_runtime_project_attachment": close({res.google_apihub_runtime_project_attachment & cuetf.MetaArgs})
	...
	_#res: "\(#googlePrefix)_biglake_hive_catalog": close({res.google_biglake_hive_catalog & cuetf.MetaArgs})
	_#res: "\(#googlePrefix)_biglake_hive_catalog_iam_binding": close({res.google_biglake_hive_catalog_iam_binding & cuetf.MetaArgs})
	_#res: "\(#googlePrefix)_biglake_hive_catalog_iam_member": close({res.google_biglake_hive_catalog_iam_member & cuetf.MetaArgs})
	_#res: "\(#googlePrefix)_biglake_hive_catalog_iam_policy": close({res.google_biglake_hive_catalog_iam_policy & cuetf.MetaArgs})
	_#res: "\(#googlePrefix)_biglake_hive_database": close({res.google_biglake_hive_database & cuetf.MetaArgs})
	_#res: "\(#googlePrefix)_biglake_hive_database_iam_binding": close({res.google_biglake_hive_database_iam_binding & cuetf.MetaArgs})
	_#res: "\(#googlePrefix)_biglake_hive_database_iam_member": close({res.google_biglake_hive_database_iam_member & cuetf.MetaArgs})
	_#res: "\(#googlePrefix)_biglake_hive_database_iam_policy": close({res.google_biglake_hive_database_iam_policy & cuetf.MetaArgs})
	_#res: "\(#googlePrefix)_biglake_hive_table": close({res.google_biglake_hive_table & cuetf.MetaArgs})
	_#res: "\(#googlePrefix)_biglake_hive_table_iam_binding": close({res.google_biglake_hive_table_iam_binding & cuetf.MetaArgs})
	_#res: "\(#googlePrefix)_biglake_hive_table_iam_member": close({res.google_biglake_hive_table_iam_member & cuetf.MetaArgs})
	_#res: "\(#googlePrefix)_biglake_hive_table_iam_policy": close({res.google_biglake_hive_table_iam_policy & cuetf.MetaArgs})
	...
	_#res: "\(#googlePrefix)_bigquery_analytics_hub_query_template": close({res.google_bigquery_analytics_hub_query_template & cuetf.MetaArgs})
	...
	_#res: "\(#googlePrefix)_bigquery_data_transfer_data_source_enrollment": close({res.google_bigquery_data_transfer_data_source_enrollment & cuetf.MetaArgs})
	...
	_#res: "\(#googlePrefix)_chronicle_big_query_export": close({res.google_chronicle_big_query_export & cuetf.MetaArgs})
	_#res: "\(#googlePrefix)_chronicle_case_close_definition": close({res.google_chronicle_case_close_definition & cuetf.MetaArgs})
	_#res: "\(#googlePrefix)_chronicle_case_stage_definition": close({res.google_chronicle_case_stage_definition & cuetf.MetaArgs})
	_#res: "\(#googlePrefix)_chronicle_case_tag_definition": close({res.google_chronicle_case_tag_definition & cuetf.MetaArgs})
	...
	_#res: "\(#googlePrefix)_chronicle_data_export": close({res.google_chronicle_data_export & cuetf.MetaArgs})
	...
	_#res: "\(#googlePrefix)_chronicle_environment": close({res.google_chronicle_environment & cuetf.MetaArgs})
	_#res: "\(#googlePrefix)_chronicle_environment_group": close({res.google_chronicle_environment_group & cuetf.MetaArgs})
	_#res: "\(#googlePrefix)_chronicle_feed": close({res.google_chronicle_feed & cuetf.MetaArgs})
	_#res: "\(#googlePrefix)_chronicle_findings_refinement_deployment": close({res.google_chronicle_findings_refinement_deployment & cuetf.MetaArgs})
	...
	_#res: "\(#googlePrefix)_chronicle_soar_network": close({res.google_chronicle_soar_network & cuetf.MetaArgs})
	...
	_#res: "\(#googlePrefix)_cloud_quotas_quota_adjuster_settings": close({res.google_cloud_quotas_quota_adjuster_settings & cuetf.MetaArgs})
	...
	_#res: "\(#googlePrefix)_cloud_support_support_event_subscription": close({res.google_cloud_support_support_event_subscription & cuetf.MetaArgs})
	...
	_#res: "\(#googlePrefix)_compute_global_vm_extension_policy": close({res.google_compute_global_vm_extension_policy & cuetf.MetaArgs})
	...
	_#res: "\(#googlePrefix)_compute_network_edge_security_service": close({res.google_compute_network_edge_security_service & cuetf.MetaArgs})
	...
	_#res: "\(#googlePrefix)_compute_rollout_plan": close({res.google_compute_rollout_plan & cuetf.MetaArgs})
	...
	_#res: "\(#googlePrefix)_compute_router_named_set": close({res.google_compute_router_named_set & cuetf.MetaArgs})
	...
	_#res: "\(#googlePrefix)_data_loss_prevention_content_policy": close({res.google_data_loss_prevention_content_policy & cuetf.MetaArgs})
	...
	_#res: "\(#googlePrefix)_dataform_repository": close({res.google_dataform_repository & cuetf.MetaArgs})
	_#res: "\(#googlePrefix)_dataform_repository_iam_binding": close({res.google_dataform_repository_iam_binding & cuetf.MetaArgs})
	_#res: "\(#googlePrefix)_dataform_repository_iam_member": close({res.google_dataform_repository_iam_member & cuetf.MetaArgs})
	_#res: "\(#googlePrefix)_dataform_repository_iam_policy": close({res.google_dataform_repository_iam_policy & cuetf.MetaArgs})
	...
	_#res: "\(#googlePrefix)_eventarc_pipeline_iam_binding": close({res.google_eventarc_pipeline_iam_binding & cuetf.MetaArgs})
	_#res: "\(#googlePrefix)_eventarc_pipeline_iam_member": close({res.google_eventarc_pipeline_iam_member & cuetf.MetaArgs})
	_#res: "\(#googlePrefix)_eventarc_pipeline_iam_policy": close({res.google_eventarc_pipeline_iam_policy & cuetf.MetaArgs})
	...
	_#res: "\(#googlePrefix)_firestore_change_stream": close({res.google_firestore_change_stream & cuetf.MetaArgs})
	...
	_#res: "\(#googlePrefix)_gemini_gda_observability_setting_binding": close({res.google_gemini_gda_observability_setting_binding & cuetf.MetaArgs})
	_#res: "\(#googlePrefix)_gemini_gda_observability_setting": close({res.google_gemini_gda_observability_setting & cuetf.MetaArgs})
	...
	_#res: "\(#googlePrefix)_iam_folder_access_policy": close({res.google_iam_folder_access_policy & cuetf.MetaArgs})
	...
	_#res: "\(#googlePrefix)_iam_organization_access_policy": close({res.google_iam_organization_access_policy & cuetf.MetaArgs})
	...
	_#res: "\(#googlePrefix)_iam_project_access_policy": close({res.google_iam_project_access_policy & cuetf.MetaArgs})
	...
	_#res: "\(#googlePrefix)_iap_agent_registry_agent_iam_binding": close({res.google_iap_agent_registry_agent_iam_binding & cuetf.MetaArgs})
	_#res: "\(#googlePrefix)_iap_agent_registry_agent_iam_member": close({res.google_iap_agent_registry_agent_iam_member & cuetf.MetaArgs})
	_#res: "\(#googlePrefix)_iap_agent_registry_agent_iam_policy": close({res.google_iap_agent_registry_agent_iam_policy & cuetf.MetaArgs})
	_#res: "\(#googlePrefix)_iap_agent_registry_endpoint_iam_binding": close({res.google_iap_agent_registry_endpoint_iam_binding & cuetf.MetaArgs})
	_#res: "\(#googlePrefix)_iap_agent_registry_endpoint_iam_member": close({res.google_iap_agent_registry_endpoint_iam_member & cuetf.MetaArgs})
	_#res: "\(#googlePrefix)_iap_agent_registry_endpoint_iam_policy": close({res.google_iap_agent_registry_endpoint_iam_policy & cuetf.MetaArgs})
	...
	_#res: "\(#googlePrefix)_iap_agent_registry_mcp_server_iam_binding": close({res.google_iap_agent_registry_mcp_server_iam_binding & cuetf.MetaArgs})
	_#res: "\(#googlePrefix)_iap_agent_registry_mcp_server_iam_member": close({res.google_iap_agent_registry_mcp_server_iam_member & cuetf.MetaArgs})
	_#res: "\(#googlePrefix)_iap_agent_registry_mcp_server_iam_policy": close({res.google_iap_agent_registry_mcp_server_iam_policy & cuetf.MetaArgs})
	...
	_#res: "\(#googlePrefix)_memorystore_acl_policy": close({res.google_memorystore_acl_policy & cuetf.MetaArgs})
	...
	_#res: "\(#googlePrefix)_monitoring_snooze": close({res.google_monitoring_snooze & cuetf.MetaArgs})
	...
	_#res: "\(#googlePrefix)_network_connectivity_gateway_advertised_route": close({res.google_network_connectivity_gateway_advertised_route & cuetf.MetaArgs})
	...
	_#res: "\(#googlePrefix)_network_management_network_monitoring_provider": close({res.google_network_management_network_monitoring_provider & cuetf.MetaArgs})
	...
	_#res: "\(#googlePrefix)_observability_bucket": close({res.google_observability_bucket & cuetf.MetaArgs})
	_#res: "\(#googlePrefix)_observability_folder_settings": close({res.google_observability_folder_settings & cuetf.MetaArgs})
	_#res: "\(#googlePrefix)_observability_link": close({res.google_observability_link & cuetf.MetaArgs})
	_#res: "\(#googlePrefix)_observability_organization_settings": close({res.google_observability_organization_settings & cuetf.MetaArgs})
	_#res: "\(#googlePrefix)_observability_project_settings": close({res.google_observability_project_settings & cuetf.MetaArgs})
	...
	_#res: "\(#googlePrefix)_redis_cluster_acl_policy": close({res.google_redis_cluster_acl_policy & cuetf.MetaArgs})
	...
	_#res: "\(#googlePrefix)_scc_notification_service_account": close({res.google_scc_notification_service_account & cuetf.MetaArgs})
	...
	_#res: "\(#googlePrefix)_storage_ftp_server": close({res.google_storage_ftp_server & cuetf.MetaArgs})
	_#res: "\(#googlePrefix)_storage_ftp_user": close({res.google_storage_ftp_user & cuetf.MetaArgs})
	...
	_#res: "\(#googlePrefix)_vector_search_data_object": close({res.google_vector_search_data_object & cuetf.MetaArgs})
	_#res: "\(#googlePrefix)_vector_search_index": close({res.google_vector_search_index & cuetf.MetaArgs})
	...
	_#res: "\(#googlePrefix)_vertex_ai_evaluation_metric": close({res.google_vertex_ai_evaluation_metric & cuetf.MetaArgs})
	...
	_#res: "\(#googlePrefix)_vertex_ai_persistent_resource": close({res.google_vertex_ai_persistent_resource & cuetf.MetaArgs})
	_#res: "\(#googlePrefix)_vertex_ai_rag_corpus": close({res.google_vertex_ai_rag_corpus & cuetf.MetaArgs})
	...
	_#res: "\(#googlePrefix)_vertex_ai_semantic_governance_policy_engine": close({res.google_vertex_ai_semantic_governance_policy_engine & cuetf.MetaArgs})
