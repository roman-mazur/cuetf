...
google_network_services_wasm_plugin: {
	...
	close({
		...
		// The version referred to must be a child of this WasmPlugin resource and
		// should be listed in the "versions" field.
	...
	#log_config: close({
		...
		// If the field is not provided when logging is enabled, it is set to INFO by
		// default. Possible values: ["LOG_LEVEL_UNSPECIFIED", "TRACE", "DEBUG",
		...
		// The default value when logging is enabled is 1.0. The value of the field must
	...
	#versions: close({
		...
		// digest of the container image is saved in the imageDigest field.
		...
		// A base64-encoded string containing the configuration for the plugin. The
		// configuration is provided to the plugin at runtime through the ON_CONFIGURE
		// callback.
		// When a new WasmPluginVersion resource is created, the digest of the contents
		// is saved in the pluginConfigDigest field.
		...
		// The value is calculated based on the contents of pluginConfigData or the
		// container image defined by the pluginConfigUri field.
		...
		// When a new WasmPluginVersion resource is created, the digest of the container
		// image is saved in the pluginConfigDigest field.
