...
google_apigee_space: {
	...
	close({
		...
		// Identifier. Id of the space. This field is used as the resource name, and
		// must follow AIP-122 guidelines.
		name?: string

		// The Apigee Organization associated with the Apigee Space, in the format
