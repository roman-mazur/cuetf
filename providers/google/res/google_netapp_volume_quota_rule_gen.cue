...
google_netapp_volume_quota_rule: {
	...
	close({
		...
		// Create time of the quota rule. A timestamp in RFC3339 UTC "Zulu" format.
		...
		// Labels as key value pairs of the quota rule. Example: '{ "owner": "Bob",
		...
		// Loction of the quotaRule. QuotaRules are child resources of volumes and live
		...
		// The state of the quota rule. Possible Values : [STATE_UNSPECIFIED, CREATING,
		// UPDATING, READY, DELETING, ERROR]
		state?:   string
		project?: string
