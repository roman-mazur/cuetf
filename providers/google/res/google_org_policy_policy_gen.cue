...
google_org_policy_policy: {
	...
	#dry_run_spec: close({
		...
		// is true, policy rules set higher up in the hierarchy (up to the closest
	...
	_#defs: "/$defs/dry_run_spec/$defs/rules": close({
		...
		// Optional. Required for Managed Constraints if parameters defined in
		...
		// definition. For example: { \"allowedLocations\" : [\"us-east1\",
		// \"us-west1\"], \"allowAll\" : true }
		parameters?: string
	})
