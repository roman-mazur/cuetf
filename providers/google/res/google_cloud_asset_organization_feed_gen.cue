...
google_cloud_asset_organization_feed: {
	...
	close({
		...
		// will be returned. Possible values: ["CONTENT_TYPE_UNSPECIFIED", "RESOURCE",
		// "IAM_POLICY", "ORG_POLICY", "OS_INVENTORY", "ACCESS_POLICY"]
		content_type?: string
		...
		// This is the client-assigned asset feed identifier and it needs to be unique
