...
google_dialogflow_cx_entity_type: {
	...
	close({
		...
		// * AUTO_EXPANSION_MODE_DEFAULT: Allows an agent to recognize values that have
		// not been explicitly listed in the entity. Possible values:
		// ["AUTO_EXPANSION_MODE_DEFAULT", "AUTO_EXPANSION_MODE_UNSPECIFIED"]
		...
		// canonical values. However, list entity types can contain references to other
		...
		// and value is scallions, a synonym could be green onions.
		// For KIND_LIST entity types: This collection must contain exactly one synonym equal to value.
		synonyms?: [...string]

		// The primary value associated with this entity entry. For example, if the
		// entity type is vegetable, the value could be scallions.
		// For KIND_MAP entity types: A canonical value to be used in place of synonyms.
		// For KIND_LIST entity types: A string that can contain references to other
		// entity types (with or without aliases).
		value?: string
	})
