...
google_spanner_backup_schedule: {
	...
	close({
		...
		// Possible values are USE_DATABASE_ENCRYPTION, GOOGLE_DEFAULT_ENCRYPTION, or
		// CUSTOMER_MANAGED_ENCRYPTION.
		// If you use CUSTOMER_MANAGED_ENCRYPTION, you must specify a kmsKeyName or
		// kmsKeyNames. Possible values: ["USE_DATABASE_ENCRYPTION",
