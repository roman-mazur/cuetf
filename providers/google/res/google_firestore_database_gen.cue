...
google_firestore_database: {
	...
	close({
		...
		// The App Engine integration mode to use for this database. Possible values:
		// ["ENABLED", "DISABLED"]
		app_engine_integration_mode?: string

		// The concurrency control mode to use for this database. Possible values:
		...
		// The default value is 'DELETE_PROTECTION_STATE_UNSPECIFIED', which is
		// currently equivalent to 'DELETE_PROTECTION_DISABLED'.
		// **Note:** Additionally, to delete this database using 'terraform destroy',
		// 'deletion_policy' must be set to 'DELETE'. Possible values:
		...
		// be read from the database. See versionRetentionPeriod above; this field is
		// populated with now - versionRetentionPeriod.
		...
		// only be specified for 'ENTERPRISE' edition databases. Possible values:
		// ["DATA_ACCESS_MODE_ENABLED", "DATA_ACCESS_MODE_DISABLED"]
		...
		// If 'POINT_IN_TIME_RECOVERY_ENABLED' is selected, reads are supported on
		// selected versions of the data from within the past 7 days.
		// versionRetentionPeriod and earliestVersionTime can be used to determine the
		// supported versions. These include reads against any timestamp within the
		// past hour
		// and reads against 1-minute snapshots beyond 1 hour and within 7 days.
		// If 'POINT_IN_TIME_RECOVERY_DISABLED' is selected, reads are supported on any
		// version of the data from within the past 1 hour. Default value:
		// "POINT_IN_TIME_RECOVERY_DISABLED" Possible values:
		...
		// Any read or query can specify a readTime within this window, and will read
		// the state of the database at that time.
