...
google_document_ai_warehouse_location: {
	...
	close({
		...
		// The access control mode for accessing the customer data. Possible values:
		...
		// The type of database used to store customer data. Possible values:
		// ["DB_INFRA_SPANNER", "DB_CLOUD_SQL_POSTGRES"]
		database_type!: string

		// The default role for the person who create a document. Possible values:
		// ["DOCUMENT_ADMIN", "DOCUMENT_EDITOR", "DOCUMENT_VIEWER"]
