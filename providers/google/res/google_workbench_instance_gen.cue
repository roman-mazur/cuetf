...
google_workbench_instance: {
	...
	close({
		...
		// Desired state of the Workbench Instance. Set this field to 'ACTIVE' to start
		// the Instance, and 'STOPPED' to stop the Instance.
	...
	_#defs: "/$defs/gce_setup/$defs/accelerator_configs": close({
		...
		// Optional. Type of this accelerator. Possible values: ["NVIDIA_TESLA_P100",
		...
		// "NVIDIA_RTX6000", "NVIDIA_TESLA_T4_VWS", "NVIDIA_TESLA_P100_VWS",
		// "NVIDIA_TESLA_P4_VWS"]
		type?: string
	})
	...
	_#defs: "/$defs/gce_setup/$defs/boot_disk": close({
		...
		// Optional. Indicates the type of the disk. Possible values: ["PD_STANDARD",
		// "PD_SSD", "PD_BALANCED", "PD_EXTREME", "HYPERDISK_BALANCED",
	...
	_#defs: "/$defs/gce_setup/$defs/data_disks": close({
		...
		// Optional. Input only. Indicates the type of the disk. Possible values:
		// ["PD_STANDARD", "PD_SSD", "PD_BALANCED", "PD_EXTREME", "HYPERDISK_BALANCED",
	...
	_#defs: "/$defs/gce_setup/$defs/reservation_affinity": close({
		...
		// Possible values: ["RESERVATION_NONE", "RESERVATION_ANY",
