...
google_backup_dr_backup_plan: {
	...
	close({
		...
		// The description allows for additional details about 'BackupPlan' and its use
		...
		// This is only applicable for CloudSql resource. Days for which logs will be
		// stored. This value should be greater than or equal to minimum enforced log
		// retention duration of the backup vault.
		log_retention_days?: number

		// The maximum number of days for which an on-demand backup taken with custom
		// retention can be retained.
		...
		// "alloydb.googleapis.com/Cluster", "file.googleapis.com/Instance" and
	...
	#backup_rules: close({
		...
		// Configures the duration for which backup data will be kept. The value should
		// be greater than or equal to minimum enforced retention of the backup vault.
	...
	_#defs: "/$defs/backup_rules/$defs/standard_schedule": close({
		...
		// Specifies days of week like MONDAY or TUESDAY, on which jobs will run. This
		// is required for 'recurrence_type', 'WEEKLY' and is not applicable otherwise.
		// Possible values: ["DAY_OF_WEEK_UNSPECIFIED", "MONDAY", "TUESDAY",
		// "WEDNESDAY", "THURSDAY", "FRIDAY", "SATURDAY", "SUNDAY"]
		days_of_week?: [...string]

		// Specifies frequency for hourly backups. An hourly frequency of 2 means jobs
		// will run every 2 hours from start time till end time defined.
		// This is required for 'recurrence_type', 'HOURLY' and is not applicable otherwise.
		hourly_frequency?: number

		// Specifies values of months Possible values: ["MONTH_UNSPECIFIED", "JANUARY",
		// "FEBRUARY", "MARCH", "APRIL", "MAY", "JUNE", "JULY", "AUGUST", "SEPTEMBER",
		// "OCTOBER", "NOVEMBER", "DECEMBER"]
		months?: [...string]

		// RecurrenceType enumerates the applicable periodicity for the schedule.
		// Possible values: ["HOURLY", "DAILY", "WEEKLY", "MONTHLY", "YEARLY"]
	...
	_#defs: "/$defs/backup_rules/$defs/standard_schedule/$defs/backup_window": close({
		// The hour of the day (1-24) when the window ends, for example, if the value of
		// end hour of the day is 10, that means the backup window end time is 10:00.
		// The end hour of the day should be greater than the start
		end_hour_of_day?: number

		// The hour of the day (0-23) when the window starts, for example, if the value
		// of the start hour of the day is 6, that means the backup window starts at
		// 6:00.
		start_hour_of_day!: number
	})

	_#defs: "/$defs/backup_rules/$defs/standard_schedule/$defs/week_day_of_month": close({
		// Specifies the day of the week. Possible values: ["DAY_OF_WEEK_UNSPECIFIED",
		// "MONDAY", "TUESDAY", "WEDNESDAY", "THURSDAY", "FRIDAY", "SATURDAY",
		// "SUNDAY"]
		day_of_week!: string

		// WeekOfMonth enumerates possible weeks in the month, e.g. the first, third, or
		// last week of the month. Possible values: ["WEEK_OF_MONTH_UNSPECIFIED",
