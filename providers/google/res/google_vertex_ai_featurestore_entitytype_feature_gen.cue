...
google_vertex_ai_featurestore_entitytype_feature: {
	...
	close({
		...
		// The timestamp of when the entity type was created in RFC3339 UTC "Zulu"
		...
		// The name of the feature. The feature can be up to 64 characters long and can
		// consist only of ASCII Latin letters A-Z and a-z, underscore(_), and ASCII
		// digits 0-9 starting with a letter. The value will be unique given an entity
		// type.
		name?: string
		...
		// The timestamp when the entity type was most recently updated in RFC3339 UTC
