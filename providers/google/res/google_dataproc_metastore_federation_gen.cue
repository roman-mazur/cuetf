...
google_dataproc_metastore_federation: {
	...
	close({
		...
		// The ID of the metastore federation. The id must contain only letters (a-z,
		...
		// The Apache Hive metastore version of the federation. All backend metastore
	...
	#backend_metastores: close({
		...
		// ["METASTORE_TYPE_UNSPECIFIED", "DATAPROC_METASTORE", "BIGQUERY"]
		...
		// projects/{projectId}/locations/{location}/lakes/{lake_id} BigQuery:
		// projects/{projectId} Dataproc Metastore:
