...
google_bigquery_routine: {
	...
	close({
		...
		// If set to DATA_MASKING, the function is validated and made available as a
		// masking function. For more information, see
		...
		// The determinism level of the JavaScript UDF if defined. Possible values:
		...
		// The ID of the the routine. The ID must contain only letters (a-z, A-Z),
		...
		// Possible values: ["DEFINER", "INVOKER"]
	...
	#arguments: close({
		...
		// Specifies whether the argument is input or output. Can be set for procedures
		// only. Possible values: ["IN", "OUT", "INOUT"]
		mode?: string
	...
	#spark_options: close({
		...
		// Supported file types: .py, .egg, and .zip. For more information about Apache
