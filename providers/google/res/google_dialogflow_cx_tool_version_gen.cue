...
google_dialogflow_cx_tool_version: {
	...
	close({
		...
		// Uses RFC 3339, where generated output will always be Z-normalized and use 0,
		// 3, 6 or 9 fractional digits.
	...
	_#defs: "/$defs/tool/$defs/data_store_spec": close({
		data_store_connections!: matchN(1, [_#defs."/$defs/tool/$defs/data_store_spec/$defs/data_store_connections", [_, ...] & [..._#defs."/$defs/tool/$defs/data_store_spec/$defs/data_store_connections"]])
		fallback_prompt!: matchN(1, [_#defs."/$defs/tool/$defs/data_store_spec/$defs/fallback_prompt", list.MaxItems(1) & [_, ...] & [..._#defs."/$defs/tool/$defs/data_store_spec/$defs/fallback_prompt"]])
	})

	_#defs: "/$defs/tool/$defs/data_store_spec/$defs/data_store_connections": close({
	...
	_#defs: "/$defs/tool/$defs/data_store_spec/$defs/fallback_prompt": close({})

	_#defs: "/$defs/tool/$defs/function_spec": close({
	...
	_#defs: "/$defs/tool/$defs/open_api_spec": close({
		authentication?: matchN(1, [_#defs."/$defs/tool/$defs/open_api_spec/$defs/authentication", list.MaxItems(1) & [..._#defs."/$defs/tool/$defs/open_api_spec/$defs/authentication"]])
		service_directory_config?: matchN(1, [_#defs."/$defs/tool/$defs/open_api_spec/$defs/service_directory_config", list.MaxItems(1) & [..._#defs."/$defs/tool/$defs/open_api_spec/$defs/service_directory_config"]])
		tls_config?: matchN(1, [_#defs."/$defs/tool/$defs/open_api_spec/$defs/tls_config", list.MaxItems(1) & [..._#defs."/$defs/tool/$defs/open_api_spec/$defs/tls_config"]])
	...
	_#defs: "/$defs/tool/$defs/open_api_spec/$defs/authentication": close({
		api_key_config?: matchN(1, [_#defs."/$defs/tool/$defs/open_api_spec/$defs/authentication/$defs/api_key_config", list.MaxItems(1) & [..._#defs."/$defs/tool/$defs/open_api_spec/$defs/authentication/$defs/api_key_config"]])
		bearer_token_config?: matchN(1, [_#defs."/$defs/tool/$defs/open_api_spec/$defs/authentication/$defs/bearer_token_config", list.MaxItems(1) & [..._#defs."/$defs/tool/$defs/open_api_spec/$defs/authentication/$defs/bearer_token_config"]])
		oauth_config?: matchN(1, [_#defs."/$defs/tool/$defs/open_api_spec/$defs/authentication/$defs/oauth_config", list.MaxItems(1) & [..._#defs."/$defs/tool/$defs/open_api_spec/$defs/authentication/$defs/oauth_config"]])
		service_agent_auth_config?: matchN(1, [_#defs."/$defs/tool/$defs/open_api_spec/$defs/authentication/$defs/service_agent_auth_config", list.MaxItems(1) & [..._#defs."/$defs/tool/$defs/open_api_spec/$defs/authentication/$defs/service_agent_auth_config"]])
	})

	_#defs: "/$defs/tool/$defs/open_api_spec/$defs/authentication/$defs/api_key_config": close({
	...
	_#defs: "/$defs/tool/$defs/open_api_spec/$defs/authentication/$defs/bearer_token_config": close({
	...
	_#defs: "/$defs/tool/$defs/open_api_spec/$defs/authentication/$defs/oauth_config": close({
	...
	_#defs: "/$defs/tool/$defs/open_api_spec/$defs/authentication/$defs/service_agent_auth_config": close({
	...
	_#defs: "/$defs/tool/$defs/open_api_spec/$defs/service_directory_config": close({
	...
	_#defs: "/$defs/tool/$defs/open_api_spec/$defs/tls_config": close({
		ca_certs!: matchN(1, [_#defs."/$defs/tool/$defs/open_api_spec/$defs/tls_config/$defs/ca_certs", [_, ...] & [..._#defs."/$defs/tool/$defs/open_api_spec/$defs/tls_config/$defs/ca_certs"]])
	})

	_#defs: "/$defs/tool/$defs/open_api_spec/$defs/tls_config/$defs/ca_certs": close({
