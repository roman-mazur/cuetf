...
google_certificate_manager_certificate: {
	...
	close({
		...
		// certificates, served from Edge Points of Presence.
		// See https://cloud.google.com/vpc/docs/edge-locations.
		//
		// ALL_REGIONS: Certificates with ALL_REGIONS scope are served from all GCP
		// regions (You can only use ALL_REGIONS with global certs).
		// See https://cloud.google.com/compute/docs/regions-zones.
		//
		// CLIENT_AUTH: Certificates with CLIENT_AUTH scope are used by a load balancer
		// (TLS client) to be presented to the backend (TLS server) when backend mTLS
		// is configured.
		// See
	...
	#managed: close({
		...
		// Authorizations that will be used for performing domain authorization. Either
		// issuanceConfig or dnsAuthorizations should be specificed, but not both.
		...
		// The resource name for a CertificateIssuanceConfig used to configure private
		// PKI certificates in the format
		// projects/*/locations/*/certificateIssuanceConfigs/*.
		// If this field is not set, the certificates will instead be publicly signed as
		// documented at
