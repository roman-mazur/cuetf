...
google_storage_bucket_object: {
	...
	_#defs: "/$defs/contexts/$defs/custom": close({
		...
		// An individual object context. Context keys and their corresponding values
		...
		// The value associated with this context. This field holds the primary
		// information for the given context key.
		value!: string
	})
}
