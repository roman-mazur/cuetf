...
google_network_connectivity_service_connection_policy: {
	...
	close({
		...
		// ServiceClass.
		// It is provided by the Service Producer. Google services have a prefix of gcp.
		// For example, google-cloud-sql. 3rd party services do not. For example,
		// test-service-a3dfcx.
		//
	...
	#psc_config: close({
		// List of Projects, Folders, or Organizations from where the Producer instance
		// can be within. For example,
		...
		// network to connect with any Producer
		...
		// allowedGoogleProducersResourceHierarchyLevel is / where is one of 'projects',
		// 'folders', or 'organizations'
		// and is either the ID or the number of the resource type. Format for each
		// allowedGoogleProducersResourceHierarchyLevel value: 'projects/' or 'folders/'
		// or 'organizations/' Eg.
		...
		// ProducerInstanceLocation is used to specify which authorization mechanism to
		// use to determine which projects
