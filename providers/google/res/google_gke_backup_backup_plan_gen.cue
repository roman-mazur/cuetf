...
google_gke_backup_backup_plan: {
	...
	close({
		...
		// backupPlans.delete to ensure that their change will be applied to the same
		...
		// The number of Kubernetes Namespaces backed up in the last successful Backup
		// created via this BackupPlan.
		protected_namespace_count?: number
		project?:                   string

		// The number of Kubernetes Pods backed up in the last successful Backup created
		// via this BackupPlan.
