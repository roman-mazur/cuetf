...
google_ces_tool: {
	...
	#data_store_tool: close({
		...
		// ALWAYS_INCLUDE
		// NEVER_INCLUDE Possible values: ["FILTER_PARAMETER_BEHAVIOR_UNSPECIFIED",
	...
	#widget_tool: close({
		...
		// CONTACT_FORM Possible values: ["WIDGET_TYPE_UNSPECIFIED", "CUSTOM",
		// "PRODUCT_CAROUSEL", "PRODUCT_DETAILS", "QUICK_ACTIONS",
		// "PRODUCT_COMPARISON", "ADVANCED_PRODUCT_DETAILS", "SHORT_FORM",
		// "OVERALL_SATISFACTION", "ORDER_SUMMARY", "APPOINTMENT_DETAILS",
		// "APPOINTMENT_SCHEDULER", "CONTACT_FORM"]
		widget_type?: string
	})
	...
	_#defs: "/$defs/widget_tool/$defs/data_mapping": close({
		...
		// (e.g., a search tool or a custom function).
