...
google_network_security_server_tls_policy: {
	...
	close({
		...
		// false for external HTTPS load balancer policies.
		// Determines if server allows plaintext connections. If set to true, server
		// allows plain text connections. By default, it is set to false. This setting
		// is not exclusive of other encryption modes. For example, if allowOpen and
		// mtlsPolicy are set, server allows both plain text and mTLS connections. See
	...
	#mtls_policy: close({
		...
		// balancer, the clientValidationMode specifies how the client connection is
		// handled.
		// Required if the policy is to be used with the external HTTPS load balancing.
		// For Traffic Director it must be empty. Possible values:
