...
google_vertex_ai_featurestore: {
	...
	@jsonschema(id="https://github.com/roman-mazur/cuetf/schema/res/google_vertex_ai_featurestore")
	close({
		...
		// The timestamp of when the featurestore was created in RFC3339 UTC "Zulu"
		...
		// The timestamp of when the featurestore was last updated in RFC3339 UTC "Zulu"
		// format, with nanosecond resolution and up to nine fractional digits.
		update_time?: string
	})
	...
	#online_serving_config: close({
		...
		// The number of nodes for each cluster. The number of nodes will not scale
		// automatically but can be scaled manually by providing different values when
		// updating.
