...
google_logging_folder_bucket_config: {
	...
	@jsonschema(id="https://github.com/roman-mazur/cuetf/schema/res/google_logging_folder_bucket_config")
	close({
		...
		// The name of the logging bucket. Logging automatically creates two log
		// buckets: _Required and _Default.
		bucket_id!: string
	...
	#cmek_settings: close({
		...
		// in cases where the CMEK settings are bound to a single key version.
