...
google_logging_organization_sink: {
	...
	close({
		...
		// Whether or not to include child folders or projects in the sink export. If
		// true, logs associated with child projects are also exported; otherwise only
		// logs relating to the provided organization are included.
		include_children?: bool

		// Whether or not to intercept logs from child projects. If true, matching logs
		// will not match with sinks in child resources, except _Required sinks. This
		// sink will be visible to child resources when listing sinks.
