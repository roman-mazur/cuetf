...
google_compute_region_backend_service: {
	...
	close({
		...
		connection_tracking_policy?: matchN(1, [#connection_tracking_policy, list.MaxItems(1) & [...#connection_tracking_policy]])
		...
		// client for proxyless gRPC). Possible values: ["IPV4_ONLY", "PREFER_IPV6",
		// "IPV6_ONLY"]
		...
		// Default value: "INTERNAL" Possible values: ["EXTERNAL", "EXTERNAL_MANAGED",
		...
		// field set to true. Possible values: ["ROUND_ROBIN", "LEAST_REQUEST",
		// "RING_HASH", "RANDOM", "ORIGINAL_DESTINATION", "MAGLEV", "WEIGHTED_MAGLEV",
		...
		// the haPolicy is enabled, and for External Passthrough Network Load Balancers
		// when the haPolicy fastIpMove is enabled.
		// This field can only be specified when the load balancing scheme is set to
		// INTERNAL, or when the load balancing scheme is set to EXTERNAL and haPolicy
		...
		// for more information. Possible values: ["HTTP", "HTTPS", "HTTP2", "TCP",
		// "SSL", "UDP", "GRPC", "UNSPECIFIED", "H2C"]
		protocol?: string
		project?:  string
	...
	#backend: close({
		...
		// for an explanation of load balancing modes. Default value: "UTILIZATION"
		// Possible values: ["UTILIZATION", "RATE", "CONNECTION", "CUSTOM_METRICS"]
	...
	#cdn_policy: close({
		...
		// The possible values are: USE_ORIGIN_HEADERS, FORCE_CACHE_ALL and
		// CACHE_ALL_STATIC Possible values: ["USE_ORIGIN_HEADERS", "FORCE_CACHE_ALL",
		// "CACHE_ALL_STATIC"]
		cache_mode?: string
	...
	#connection_tracking_policy: close({
		...
		// generally not recommended to use this mode overriding the default. Default
		// value: "DEFAULT_FOR_PROTOCOL" Possible values: ["DEFAULT_FOR_PROTOCOL",
		// "NEVER_PERSIST", "ALWAYS_PERSIST"]
		...
		// Default value: "PER_CONNECTION" Possible values: ["PER_CONNECTION",
		// "PER_SESSION"]
	...
	#log_config: close({
		...
		// Specifies the fields to include in logging. This field can only be specified
		// if logging is enabled for this backend service.
		optional_fields?: [...string]

		// Specifies the optional logging mode for the load balancer traffic.
		// Supported values: INCLUDE_ALL_OPTIONAL, EXCLUDE_ALL_OPTIONAL, CUSTOM.
		// Possible values: ["INCLUDE_ALL_OPTIONAL", "EXCLUDE_ALL_OPTIONAL", "CUSTOM"]
	...
	#tls_settings: close({
		...
		// Can be used in authenticating TLS connections to the backend, as specified by
		// the authenticationMode field.
		// Can only be specified if authenticationMode is not NONE.
		authentication_config?: string

		// Server Name Indication - see RFC3546 section 3.1. If set, the load balancer
		// sends this string as the SNI hostname in the
		// TLS connection to the backend, and requires that this string match a Subject
		// Alternative Name (SAN) in the backend's
		// server certificate. With a Regional Internet NEG backend, if the SNI is
		// specified here, the load balancer uses it
	...
	_#defs: "/$defs/cdn_policy/$defs/negative_caching_policy": close({
		...
		// 301, 308, 404, 405, 410, 421, 451 and 501
	...
	_#defs: "/$defs/network_pass_through_lb_traffic_policy/$defs/zonal_affinity": close({
		// This field indicates whether zonal affinity is enabled or not. Default value:
		// "ZONAL_AFFINITY_DISABLED" Possible values: ["ZONAL_AFFINITY_DISABLED",
		// "ZONAL_AFFINITY_SPILL_CROSS_ZONE", "ZONAL_AFFINITY_STAY_WITHIN_ZONE"]
		spillover?: string

		// The value of the field must be in [0, 1]. When the ratio of the count of
		// healthy backend endpoints in a zone
		// to the count of backend endpoints in that same zone is equal to or above this
		// threshold, the load balancer
		// distributes new connections to all healthy endpoints in the local zone only.
		// When the ratio of the count
		// of healthy backend endpoints in a zone to the count of backend endpoints in
		// that same zone is below this
		// threshold, the load balancer distributes all new connections to all healthy
