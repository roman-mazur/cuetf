...
google_access_context_manager_gcp_user_access_binding: {
	...
	close({
		...
		// 3986 Section 2.3). Should not be specified by the client during creation.
	...
	#session_settings: close({
		...
		// session length is up. Possible values: ["LOGIN", "SECURITY_KEY", "PASSWORD"]
		...
		// period will be the minimum of the sessionLength field and the max_age OIDC
		// param.
