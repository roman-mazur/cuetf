...
google_compute_organization_security_policy: {
	...
	close({
		...
		// The type indicates the intended use of the security policy. This field can be
		// set only at resource creation time.
		//
		// **NOTE** : 'FIREWALL' type is deprecated and will be removed in a future
		// major release. Please use 'google_compute_firewall_policy' instead."
		// Possible values: ["FIREWALL", "CLOUD_ARMOR", "CLOUD_ARMOR_EDGE",
	...
	#advanced_options_config: close({
		...
		// supported are "8KB", "16KB", "32KB", "48KB" and "64KB".
		...
		// resolving the client source IP address.
