...
google_compute_region_instance_group_manager: {
	...
	#update_policy: close({
		...
		// Valid values are: "PROACTIVE", "NONE". If PROACTIVE (default), the group
		// attempts to maintain an even distribution of VM instances across zones in
		// the region. If NONE, proactive redistribution is disabled.
		...
		// The instance replacement method for regional managed instance groups. Valid
		// values are: "RECREATE", "SUBSTITUTE". If SUBSTITUTE (default), the group
		// replaces VM instances with new instances that have randomly generated names.
		// If RECREATE, instance names are preserved. You must also set
