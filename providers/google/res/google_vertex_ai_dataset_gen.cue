...
google_vertex_ai_dataset: {
	...
	close({
		...
		// The timestamp of when the dataset was created in RFC3339 UTC "Zulu" format,
		...
		// The user-defined name of the Dataset. The name can be up to 128 characters
		...
		// information about the Dataset. The schema is defined as an OpenAPI 3.0.2
		// Schema Object. The schema files that can be used here are found in
		...
		// The timestamp of when the dataset was last updated in RFC3339 UTC "Zulu"
