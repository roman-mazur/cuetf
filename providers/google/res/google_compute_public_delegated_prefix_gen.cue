...
google_compute_public_delegated_prefix: {
	...
	close({
		...
		// field is optional and cannot be set for prefixes in DELEGATION mode. It
		// cannot be set for IPv4 prefixes either, and it always defaults to 32.
		...
		// * INTERNAL_IPV6_SUBNETWORK_CREATION Possible values: ["DELEGATION",
		// "EXTERNAL_IPV6_FORWARDING_RULE_CREATION",
