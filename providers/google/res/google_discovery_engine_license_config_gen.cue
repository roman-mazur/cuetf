...
google_discovery_engine_license_config: {
	...
	close({
		...
		// Subscription term. Possible values: ["SUBSCRIPTION_TERM_UNSPECIFIED",
		// "SUBSCRIPTION_TERM_ONE_MONTH", "SUBSCRIPTION_TERM_ONE_YEAR",
		// "SUBSCRIPTION_TERM_THREE_YEARS", "SUBSCRIPTION_TERM_THREE_MONTHS",
		// "SUBSCRIPTION_TERM_FOURTEEN_DAYS", "SUBSCRIPTION_TERM_CUSTOM"]
		subscription_term!: string
		project?:           string

		// Subscription tier information for the license config. Possible values:
