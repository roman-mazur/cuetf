...
google_gemini_gemini_gcp_enablement_setting_binding: {
	...
	@jsonschema(id="https://github.com/roman-mazur/cuetf/schema/res/google_gemini_gemini_gcp_enablement_setting_binding")
	close({
		timeouts?: #timeouts
		...
		// Product type of the setting binding. Values include GEMINI_IN_BIGQUERY,
		// GEMINI_CLOUD_ASSIST, etc. See [product
