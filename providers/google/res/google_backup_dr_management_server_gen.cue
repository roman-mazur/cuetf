...
google_backup_dr_management_server: {
	...
	close({
		...
		// The type of management server (management console). Default value:
		// "BACKUP_RESTORE" Possible values: ["BACKUP_RESTORE"]
		type?:    string
		project?: string
	})
	...
	#networks: close({
		...
		// Type of Network peeringMode Default value: "PRIVATE_SERVICE_ACCESS" Possible
