...
google_scc_management_organization_security_health_analytics_custom_module: {
	...
	@jsonschema(id="https://github.com/roman-mazur/cuetf/schema/res/google_scc_management_organization_security_health_analytics_custom_module")
	close({
		...
		// The id {securityHealthAnalyticsCustomModule} is server-generated and is not
	...
	#custom_config: close({
		...
		predicate!: matchN(1, [_#defs."/$defs/custom_config/$defs/predicate", list.MaxItems(1) & [_, ...] & [..._#defs."/$defs/custom_config/$defs/predicate"]])
		resource_selector!: matchN(1, [_#defs."/$defs/custom_config/$defs/resource_selector", list.MaxItems(1) & [_, ...] & [..._#defs."/$defs/custom_config/$defs/resource_selector"]])
