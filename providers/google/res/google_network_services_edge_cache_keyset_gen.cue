...
google_network_services_edge_cache_keyset: {
	...
	#public_key: close({
		...
		// which means the first character must be a letter, and all following
		...
		// The base64-encoded value of the Ed25519 public key. The base64 encoding can
		// be padded (44 bytes) or unpadded (43 bytes).
	...
	#validation_shared_keys: close({
		...
		// secrets themselves.
		// The secrets must be at least 16 bytes large. The recommended secret size
		// depends on the signature algorithm you are using.
