...
google_dataplex_glossary_term: {
	...
	close({
		...
		// User friendly display name of the GlossaryTerm. This is user-mutable. This
		// will be same as the termId, if not specified.
		display_name?: string
		...
		// The immediate parent of the GlossaryTerm in the resource-hierarchy. It can
		// either be a Glossary or a Term. Format:
		...
		// System generated unique id for the GlossaryTerm. This ID will be different if
		// the GlossaryTerm is deleted and re-created with the same name.
		uid?: string
