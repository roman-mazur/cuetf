...
google_scc_v2_organization_scc_big_query_exports: {
	...
	@jsonschema(id="https://github.com/roman-mazur/cuetf/schema/res/google_scc_v2_organization_scc_big_query_exports")
	close({
		timeouts?: #timeouts
		...
		// The time at which the BigQuery export was created. This field is set by the
		...
		// The most recent time at which the BigQuery export was updated. This field is
		// set by the server and will be ignored if provided on export creation or
		// update.
		// A timestamp in RFC3339 UTC "Zulu" format, with nanosecond resolution and up
		// to nine fractional digits.
		// Examples: "2014-10-02T15:01:23Z" and "2014-10-02T15:01:23.045123456Z".
