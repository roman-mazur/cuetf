...
google_dialogflow_environment: {
	...
	#text_to_speech_settings: close({
		...
		// Indicates whether text to speech is enabled. Even when this field is false,
		// other settings in this proto are still retained.
		enable_text_to_speech?: bool

		// Audio encoding of the synthesized audio content. Possible values:
	...
	_#defs: "/$defs/fulfillment/$defs/features": close({
		// The type of the feature that enabled for fulfillment. Possible values:
