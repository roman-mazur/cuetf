...
google_firebase_app_check_recaptcha_enterprise_config: {
	...
	close({
		...
		// The score-based site key created in reCAPTCHA Enterprise used to invoke
		// reCAPTCHA and generate the reCAPTCHA tokens for your application.
		//
		// **Important**: This is not the siteSecret (as it is in reCAPTCHA v3), but
