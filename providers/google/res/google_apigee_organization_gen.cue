...
google_apigee_organization: {
	...
	close({
		...
		// when there are no runtime instances. For example: "default".
		...
		// soft-deleted (i.e., BillingType
		// is not EVALUATION). It controls how long Organization data will be retained
		// after the initial delete
		// operation completes. During this period, the Organization may be restored to
		// its last known state.
		// After this period, the Organization will no longer be able to be restored.
		// Default value: "DELETION_RETENTION_UNSPECIFIED" Possible values:
		...
		// purchased. Default value: "CLOUD" Possible values: ["CLOUD", "HYBRID"]
		runtime_type?: string

		// Output only. Subscription type of the Apigee organization.
		// Valid values include trial (free, limited, and for evaluation purposes only)
		// or paid (full subscription has been purchased).
