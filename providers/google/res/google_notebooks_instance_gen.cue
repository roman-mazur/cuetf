...
google_notebooks_instance: {
	...
	close({
		...
		// Desired state of the Notebook Instance. Set this field to 'ACTIVE' to start
		// the Instance, and 'STOPPED' to stop the Instance.
		desired_state?: string

		// Disk encryption method used on the boot and data disks, defaults to GMEK.
		// Possible values: ["DISK_ENCRYPTION_UNSPECIFIED", "GMEK", "CMEK"]
	...
	#accelerator_config: close({
		...
		// Type of this accelerator. Possible values: ["ACCELERATOR_TYPE_UNSPECIFIED",
	...
	#reservation_affinity: close({
		// The type of Compute Reservation. Possible values: ["NO_RESERVATION",
	...
	#shielded_instance_config: close({
		...
		// monitoring and attestation of the
		// boot integrity of the instance. The attestation is performed against the
		...
		// authentic software by verifying the digital signature of all boot components,
		// and halting the boot process
