...
google_dataplex_glossary: {
	...
	close({
		...
		// User friendly display name of the glossary. This is user-mutable. This will
		// be same as the glossaryId, if not specified.
		display_name?: string
		...
		// System generated unique id for the Glossary. This ID will be different if the
