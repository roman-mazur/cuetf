...
#google_migration_center_source: {
	...
	close({
		...
		// The number of frames that were reported by the source and
		// contained errors.
		...
		// User specified ID for the source. It will become the last
		// component of the
		// source name. The ID must be unique within the project, must
		// conform with
