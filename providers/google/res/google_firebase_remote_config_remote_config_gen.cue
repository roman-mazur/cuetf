...
google_firebase_remote_config_remote_config: {
	...
	#conditions: close({
		...
		// Not specifying this value results in the Console picking an arbitrary color
		// to associate with the condition. Possible values: ["BLUE", "BROWN", "CYAN",
		// "DEEP_ORANGE", "GREEN", "INDIGO", "LIME", "ORANGE", "PINK", "PURPLE",
		// "TEAL"]
		tag_color?: string
	})
