...
#google_migration_center_assets_export_job: {
	...
	close({
		...
		// When this value is set to 'true' the response will include all
		// assets,
	...
	#performance_data: close({
		...
		// for which data is available. When this value is unset (or set
		// to zero),
		// all available data is returned.
		// The maximum value is 420; values above 420 will be coerced to
		// 420.
