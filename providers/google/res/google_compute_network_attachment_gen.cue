...
google_compute_network_attachment: {
	...
	close({
		...
		// accepts the connection from consumer forwarding rules. Possible values:
		...
		// field is used in optimistic locking. An up-to-date fingerprint must be
		...
		// The URL of the network which the Network Attachment belongs to. Practically
		// it is inferred by fetching the network of the first subnetwork associated.
		// Because it is required that all the subnetworks must be from the same
		// network, it is assured that the Network Attachment belongs to the same
		...
		// URL of the region where the network attachment resides. This field applies
		// only to the region resource. You must specify this field as part of the HTTP
