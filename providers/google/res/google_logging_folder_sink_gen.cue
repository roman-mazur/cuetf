...
google_logging_folder_sink: {
	...
	close({
		...
		// The folder to be exported to the sink. Note that either [FOLDER_ID] or
		// "folders/[FOLDER_ID]" is accepted.
		folder!: string
		id?:     string

		// Whether or not to include children folders in the sink export. If true, logs
		// associated with child projects are also exported; otherwise only logs
		// relating to the provided folder are included.
