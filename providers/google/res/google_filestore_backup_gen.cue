...
google_filestore_backup: {
	...
	close({
		...
		// projects/{projectId}/locations/{locationId}/instances/{instanceId}, used to
		// create this backup.
		...
		// The size of the storage used by the backup. As backups share storage, this
		// number is expected to change with backup creation/deletion.
