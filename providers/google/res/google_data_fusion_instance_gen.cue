...
google_data_fusion_instance: {
	...
	close({
		...
		// - ENTERPRISE: Enterprise Data Fusion instance. In Enterprise type, the user
		// will have more features
		// available, such as support for streaming pipelines, higher number of concurrent pipelines, etc.
		// - DEVELOPER: Developer Data Fusion instance. In Developer type, the user will
		// have all features available but
		// with restrictive capabilities. This is to help enterprises design and develop
		// their data ingestion and integration
	...
	#accelerators: close({
		// The type of an accelator for a CDF instance. Possible values: ["CDC",
		// "HEALTHCARE", "CCAI_INSIGHTS"]
	...
	#network_config: close({
		...
		// the Data Fusion customer project VPC and
		// the corresponding tenant project from a predefined list of available connection modes.
		// If this field is unspecified for a private instance, VPC peering is used.
		// Possible values: ["VPC_PEERING", "PRIVATE_SERVICE_CONNECT_INTERFACES"]
		...
		// network resides in another host
	...
	_#defs: "/$defs/maintenance_policy/$defs/maintenance_window/$defs/recurring_time_window": close({
		...
		// An RRULE with format RFC-5545 for how this window reccurs. They go on for the
		// span of time between the start and end time. The only supported FREQ value
		// is "WEEKLY". To have something repeat every weekday, use:
	...
	_#defs: "/$defs/network_config/$defs/private_service_connect_config": close({
		...
		// traffic to in the consumer project VPC.
		// The size of this block should be at least /25. This range should not overlap
		// with the primary address range of any subnetwork used by the network
		// attachment.
		// This range can be used for other purposes in the consumer VPC as long as
		// there is no requirement for CDF to reach destinations using these addresses.
		// If this value is not provided, the server chooses a non RFC 1918 address
		// range. The format of this field is governed by RFC 4632.
