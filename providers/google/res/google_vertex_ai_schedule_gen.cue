...
google_vertex_ai_schedule: {
	...
	close({
		...
		// completed when either started_run_count >= max_run_count or when end_time is
		...
		// Timestamp after which the first run can be scheduled. Default to Schedule
		// create time if not specified.
		start_time?: string
		project?:    string
