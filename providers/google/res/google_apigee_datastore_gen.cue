...
#google_apigee_datastore: {
	...
	close({
		...
		// The time at which the datastore was created in milliseconds
		// since the epoch.
		create_time?: string
		...
		// The time at which the datastore was last updated in
		// milliseconds since the epoch.
		last_update_time?: string

		// The server-assigned UUID identifier for the datastore.
		// Extracted
		...
		// The resource link for the datastore, including the full API
		// path.
		self?: string
	...
	#datastore_config: close({
		// The name of the Cloud Storage bucket. Required for 'gcs' target
		// type.
		bucket_name?: string

		// The name of the BigQuery dataset. Required for 'bigquery'
		// target type.
		dataset_name?: string

		// The path within the Cloud Storage bucket. Used for 'gcs' target
		// type.
		path?: string
		...
		// The prefix for BigQuery table names. Used for 'bigquery' target
		// type.
		table_prefix?: string
	})
