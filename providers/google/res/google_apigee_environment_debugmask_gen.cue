...
#google_apigee_environment_debugmask: {
	...
	close({
		...
		// List of XPath expressions that specify the XML elements or
		// attributes that the debug mask applies to for fault messages.
		...
		// List of JSONPath expressions that specify the JSON elements or
		// attributes that the debug mask applies to for request
		// messages.
		...
		// List of JSONPath expressions that specify the JSON elements or
		// attributes that the debug mask applies to for response
		// messages.
