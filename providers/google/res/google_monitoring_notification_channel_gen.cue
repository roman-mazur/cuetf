...
google_monitoring_notification_channel: {
	...
	#sensitive_labels: close({
		// An authorization token for a notification channel. Channel types that support
		// this field include: slack
		auth_token?: string
		...
		// Triggers update of 'auth_token_wo' write-only. Increment this value when an
		// update to 'auth_token_wo' is needed. For more info see [updating write-only
		...
		// An password for a notification channel. Channel types that support this field
		// include: webhook_basicauth
		password?: string
		...
		// An servicekey token for a notification channel. Channel types that support
		// this field include: pagerduty
		service_key?: string
		...
		// Triggers update of 'service_key_wo' write-only. Increment this value when an
		// update to 'service_key_wo' is needed. For more info see [updating write-only
		// arguments](/docs/providers/google/guides/using_write_only_arguments.html#updating-write-only-arguments)
