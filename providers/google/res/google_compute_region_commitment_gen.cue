...
google_compute_region_commitment: {
	...
	close({
		...
		// Note that only MACHINE commitments should have a Type specified. Possible
		// values: ["LICENSE", "MACHINE"]
		category?: string
		...
		// The currently supported plans are TWELVE_MONTH (1 year), and THIRTY_SIX_MONTH
		// (3 years). Possible values: ["TWELVE_MONTH", "THIRTY_SIX_MONTH"]
		plan!: string
