...
google_binary_authorization_policy: {
	...
	#cluster_admission_rules: close({
		...
		// The action when a pod creation is denied by the admission rule. Possible
		// values: ["ENFORCED_BLOCK_AND_AUDIT_LOG", "DRYRUN_AUDIT_LOG_ONLY"]
		enforcement_mode!: string

		// How this admission rule will be evaluated. Possible values: ["ALWAYS_ALLOW",
