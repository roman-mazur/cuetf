...
#google_firebase_app_check_resource_policy: {
	...
	close({
		...
		// Check. This will override the EnforcementMode setting on the
		// service.
		// Valid values are:
		//
		// (Unset)
		...
		// The identifier of the service to configure a Resource Policy
		// for.
		//
		...
		// Service specific name of the resource object to which this
		// policy applies, in the format:
