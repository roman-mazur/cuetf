...
#google_dataplex_metadata_feed: {
	...
	close({
		...
		// The metadata job ID. If not provided, a unique ID is generated
		...
		// The pubsub topic that you want the metadata feed messages to
		// publish to. Please grant Dataplex service account the
		// permission to publish messages to the topic. The service
		// account is:
		...
		// A system-generated, globally unique ID for the metadata job. If
		// the metadata job is deleted and then re-created with the same
	...
	#filters: close({
		// The aspect types that you want to listen to. Depending on how
		...
		// The type of change that you want to listen to. If not
		// specified, all changes are published.
		change_types?: [...string]

		// The entry types that you want to listen to, specified as
	...
	#scope: close({
		// The entry groups whose entries you want to listen to. Must be
		// in the format:
		...
		// If false, you must specify a list of projects or a list of
		// entry groups whose entries you want to listen to.The default
		// is false.
		organization_level?: bool

		// The projects whose entries you want to listen to. Must be in
		// the same organization as the feed. Must be in the format:
