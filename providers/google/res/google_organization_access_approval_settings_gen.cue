...
google_organization_access_approval_settings: {
	...
	@jsonschema(id="https://github.com/roman-mazur/cuetf/schema/res/google_organization_access_approval_settings")
	close({
		...
		// configured on this Organization (e.g. it doesn't exist or the Access Approval
