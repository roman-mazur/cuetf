...
google_apigee_control_plane_access: {
	...
	close({
		...
		// Array of service accounts authorized to publish analytics data to the control
		// plane, each specified using the following format:
		...
		// Array of service accounts to grant access to control plane resources (for the
		// Synchronizer component), each specified using the following format:
		// 'serviceAccount:service-account-name'.
		//
		// The 'service-account-name' is formatted like an email address. For example:
		// serviceAccount@my_project_id.iam.gserviceaccount.com
