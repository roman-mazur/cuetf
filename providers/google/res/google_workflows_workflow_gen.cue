...
google_workflows_workflow: {
	...
	close({
		...
		// The timestamp of when the workflow was created in RFC3339 UTC "Zulu" format,
		...
		// defaults to EXECUTION_HISTORY_LEVEL_UNSPECIFIED. Possible values:
		// ["EXECUTION_HISTORY_LEVEL_UNSPECIFIED", "EXECUTION_HISTORY_BASIC",
		...
		// The revision of the workflow. A new one is generated if the service account
		// or source contents is changed.
		revision_id?: string
		project?:     string
		...
		// The timestamp of when the workflow was last updated in RFC3339 UTC "Zulu"
