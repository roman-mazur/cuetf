...
#google_apigee_data_collector: {
	...
	close({
		...
		// The time at which the data collector was created in
		...
		// The time at which the data collector was last modified in
		// milliseconds since the epoch.
		...
		// The Apigee Organization associated with the Apigee data
		// collector,
		// in the format 'organizations/{{org_name}}'.
		org_id!: string

		// The type of data this data collector will collect. Possible
		// values: ["BOOLEAN", "DATETIME", "FLOAT", "INTEGER", "STRING"]
		type!: string
	})
