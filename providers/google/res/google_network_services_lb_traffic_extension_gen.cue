...
google_network_services_lb_traffic_extension: {
	...
	_#defs: "/$defs/extension_chains/$defs/extensions": close({
		...
		// Metadata associated with the extension. This field is used to pass metadata
		...
		// This field is required for the LbTrafficExtension resource. It's not relevant
		// for the LbRouteExtension
		// resource. Possible values:'EVENT_TYPE_UNSPECIFIED', 'REQUEST_HEADERS',
