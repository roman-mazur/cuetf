...
#google_migration_center_import_job: {
	...
	@jsonschema(id="https://github.com/roman-mazur/cuetf/schema/res/google_migration_center_import_job")
	close({
		timeouts?: #timeouts
		...
		execution_report?: [...close({
			execution_errors?: [...close({
				file_validations?: [...close({
					file_errors?: [...close({
