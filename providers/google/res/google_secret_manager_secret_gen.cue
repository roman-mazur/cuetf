...
google_secret_manager_secret: {
	...
	close({
		...
		// Timestamp in UTC when the Secret is scheduled to expire. This is always
	...
	#rotation: close({
		...
		// 3600s (1h) and at most 3153600000s (100 years).
	...
	#topics: close({
		...
		// must have pubsub.publisher permissions on the topic.
		name!: string
	})
