...
google_compute_address: {
	...
	close({
		...
		// Note: if you set this argument's value as 'INTERNAL' you need to leave the
		// 'network_tier' argument unset in that resource block. Default value:
		...
		// Reference to the source of external IPv4/IPv6 addresses, like a
		...
		// Use one of the following formats to specify a PDP when reserving an external
		// IPv4 address using BYOIP.
		...
		// The IP Version that will be used by this address. The default value is
		...
		// This argument should not be used when configuring Internal addresses, because
		// [network tier cannot be set for internal traffic; it's always
		// Premium](https://cloud.google.com/network-tiers/docs/overview). Possible
