...
google_compute_region_network_endpoint_group: {
	...
	close({
		...
		// Type of network endpoints in this network endpoint group. Defaults to
		// SERVERLESS. Default value: "SERVERLESS" Possible values: ["SERVERLESS",
		// "PRIVATE_SERVICE_CONNECT", "INTERNET_IP_PORT", "INTERNET_FQDN_PORT",
		// "GCE_VM_IP_PORTMAP"]
	...
	#app_engine: close({
		...
		// them to { service = "foo1", version = "v1" } and { service = "foo1", version
		// = "v2" } respectively.
		url_mask?: string
