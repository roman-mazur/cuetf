...
google_compute_region_autoscaler: {
	...
	_#defs: "/$defs/autoscaling_policy/$defs/scaling_schedules": close({
		...
		// recommendations. If set to true, then a scaling schedule has no effect.
		disabled?: bool

		// The duration of time intervals (in seconds) for which this scaling schedule
		// will be running. The minimum allowed value is 300.
		duration_sec!: number

		// Minimum number of VM instances that autoscaler will recommend in time
		// intervals starting according to schedule.
