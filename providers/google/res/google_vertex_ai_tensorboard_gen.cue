...
google_vertex_ai_tensorboard: {
	...
	close({
		...
		// Consumer project Cloud Storage path prefix used to store blob data, which can
		// either be a bucket or directory. Does not end with a '/'.
		blob_storage_path_prefix?: string

		// The timestamp of when the Tensorboard was created in RFC3339 UTC "Zulu"
		...
		// The timestamp of when the Tensorboard was last updated in RFC3339 UTC "Zulu"
		// format, with nanosecond resolution and up to nine fractional digits.
		update_time?: string
	})
