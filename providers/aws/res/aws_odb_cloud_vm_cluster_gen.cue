...
aws_odb_cloud_vm_cluster: {
	...
	close({
		...
		// The compute model used when the instance is created or cloned — either ECPU
		// or OCPU. ECPU is a virtualized compute unit; OCPU is a physical processor
		// core with hyper-threading.
		...
		// A user-friendly name for the VM cluster. This member is required. Changing
		...
		// the Exadata infrastructure. Example: 19.0.0.0 This member is required.
		// Changing this will create a new resource.
		gi_version!: string
		...
		// The host name prefix for the VM cluster. Constraints: - Can't be "localhost"
		// or "hostname". - Can't contain "-version". - The maximum length of the
		// combined hostname and domain is 63 characters. - The hostname must be unique
		// within the subnet. This member is required. Changing this will create a new
		// resource.
		hostname_prefix!: string

		// The host name for the VM cluster. Constraints: - Can't be "localhost" or
		// "hostname". - Can't contain "-version". - The maximum length of the combined
		// hostname and domain is 63 characters. - The hostname must be unique within
		// the subnet. This member is required. Changing this will create a new
		// resource.
		...
		// Specifies whether to create a sparse disk group for the VM cluster. Changing
		// this will create a new resource.
		...
		// The unique identifier of the ODB network for the VM cluster. This member is
		...
		// listener. Valid values: 1024–8999 with the following exceptions: 2484 , 6100
		// , 6200 , 7060, 7070 , 7085 , and 7879Default: 1521. Changing this will
		...
		// cluster. This member is required. Changing this will create a new resource.
		...
		// The virtual IP (VIP) addresses assigned to the VM cluster. CRS assigns one
		// VIP per node for failover support.
		vip_ids?: [...string]
		tags?: [string]:     string
