...
#aws_odb_network: {
	...
	close({
		...
		// The AZ ID of the AZ where the ODB network is located. Changing this will
		// force terraform to create new resource.
		availability_zone_id!: string

		// The CIDR range of the backup subnet for the ODB network. Changing this will
		// force terraform to create new resource.
		// Constraints:
		...
		// The CIDR notation for the network resource. Changing this will force
		...
		// and default_dns_prefix both can't be given.
		custom_domain_name?: string

		// The default DNS prefix for the network resource. Changing this will force
		// terraform to create new resource.
		...
		// The user-friendly name for the odb network. Changing this will force
		// terraform to create a new resource.
		display_name!: string
