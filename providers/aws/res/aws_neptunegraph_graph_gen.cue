...
#aws_neptunegraph_graph: {
	...
	close({
		...
		// and its first character must be a letter. It cannot end with a hyphen or
		// contain two consecutive hyphens.
		// If you don't specify a graph name, a unique graph name is generated for you
		// using the prefix graph-for,
