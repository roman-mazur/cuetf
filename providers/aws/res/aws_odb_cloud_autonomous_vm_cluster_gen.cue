...
aws_odb_cloud_autonomous_vm_cluster: {
	...
	close({
		...
		// cluster, in TB. Changing this will force terraform to create new resource.
		...
		// The database servers in the Autonomous VM cluster. Changing this will force
		...
		// The display name of the Autonomous VM cluster. Changing this will force
		// terraform to create new resource.
		display_name!: string
		...
		// Autonomous VM cluster. Changing this will force terraform to create new
		// resource.
		is_mtls_enabled_vm_cluster?: bool
		id?:                         string

		// The license model for the Autonomous VM cluster. Valid values are
		// LICENSE_INCLUDED or BRING_YOUR_OWN_LICENSE . Changing this will force
		// terraform to create new resource.
		...
		// The amount of memory allocated per Oracle Compute Unit, in GB. Changing this
		...
		// Cluster. Changing this will force terraform to create new resource.
		...
		// The SCAN listener port for TLS (TCP) protocol. The default is 2484. Changing
		...
		// The status of the Autonomous VM cluster. Possible values include CREATING,
		...
		// The time zone of the Autonomous VM cluster. Changing this will force
		// terraform to create new resource.
		time_zone?: string
		tags?: [string]: string

		// The total number of Autonomous Container Databases that can be created with
		// the allocated local storage. Changing this will force terraform to create
		// new resource.
