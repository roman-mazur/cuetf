...
#aws_odb_cloud_exadata_infrastructure: {
	...
	close({
		...
		// located. Changing this will force terraform to create new resource
		availability_zone?: string

		// The AZ ID of the AZ where the Exadata infrastructure is located. Changing
		...
		// maintenance updates for the Exadata infrastructure. Changing this will force
		...
		// The user-friendly name for the Exadata infrastructure. Changing this will
		...
		// The model name of the Exadata infrastructure. Changing this will force
		// terraform to create new resource
		shape!: string
