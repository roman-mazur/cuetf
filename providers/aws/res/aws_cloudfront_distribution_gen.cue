...
aws_cloudfront_distribution: {
	...
	_#defs: "/$defs/origin/$defs/custom_origin_config": close({
		origin_mtls_config?: matchN(1, [_#defs."/$defs/origin/$defs/custom_origin_config/$defs/origin_mtls_config", list.MaxItems(1) & [..._#defs."/$defs/origin/$defs/custom_origin_config/$defs/origin_mtls_config"]])
		http_port!:                number
		https_port!:               number
