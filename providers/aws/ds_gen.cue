...
#Terraform: {
	...
	_#ds: "\(#awsPrefix)_accountaccess_application": close({data.aws_accountaccess_application & cuetf.MetaArgs})
	_#ds: "\(#awsPrefix)_accountaccess_entitlements": close({data.aws_accountaccess_entitlements & cuetf.MetaArgs})
	...
	_#ds: "\(#awsPrefix)_agentregistry_registry": close({data.aws_agentregistry_registry & cuetf.MetaArgs})
	...
	_#ds: "\(#awsPrefix)_elasticache_service_update_actions": close({data.aws_elasticache_service_update_actions & cuetf.MetaArgs})
	...
	_#ds: "\(#awsPrefix)_rds_events": close({data.aws_rds_events & cuetf.MetaArgs})
	...
	_#ds: "\(#awsPrefix)_rds_snapshots": close({data.aws_rds_snapshots & cuetf.MetaArgs})
	...
	_#ds: "\(#awsPrefix)_resiliencehubv2_policy": close({data.aws_resiliencehubv2_policy & cuetf.MetaArgs})
	_#ds: "\(#awsPrefix)_resiliencehubv2_service": close({data.aws_resiliencehubv2_service & cuetf.MetaArgs})
	_#ds: "\(#awsPrefix)_resiliencehubv2_system": close({data.aws_resiliencehubv2_system & cuetf.MetaArgs})
	...
	_#ds: "\(#awsPrefix)_s3_buckets": close({data.aws_s3_buckets & cuetf.MetaArgs})
	...
	_#ds: "\(#awsPrefix)_vpclattice_service_network_service_associations": close({data.aws_vpclattice_service_network_service_associations & cuetf.MetaArgs})
