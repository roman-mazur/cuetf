...
elasticstack_kibana_security_exception_list: {
	...
	close({
		...
		// The unique identifier of the exception list (auto-generated by Kibana).
		id?: string
		...
		// Determines whether the exception list is available in all Kibana spaces or
		...
		// The type of exception list. Can be one of: `detection`, `endpoint`,
		// `endpoint_trusted_apps`, `endpoint_events`,
		// `endpoint_host_isolation_exceptions`, `endpoint_blocklists`, `rule_default`.
		type!: string
