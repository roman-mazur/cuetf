...
elasticstack_elasticsearch_ml_calendar: {
	...
	@jsonschema(id="https://github.com/roman-mazur/cuetf/schema/res/elasticstack_elasticsearch_ml_calendar")
	close({
		elasticsearch_connection?: matchN(1, [#elasticsearch_connection, [...#elasticsearch_connection]])

		// A string that uniquely identifies a calendar. Must contain lowercase
