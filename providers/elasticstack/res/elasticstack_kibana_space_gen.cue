...
elasticstack_kibana_space: {
	...
	close({
		...
		// The hexadecimal color code used in the space avatar. By default, the color is
		// automatically generated from the space name.
		color?: string
		timeouts?: close({
		...
		// The list of disabled features for the space. To get a list of available
		// feature IDs, use the Features API
		...
		// The initials shown in the space avatar. By default, the initials are
		// automatically generated from the space name. Initials must be 1 or 2
		// characters.
		initials?: string
