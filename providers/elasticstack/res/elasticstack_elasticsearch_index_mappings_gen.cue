...
elasticstack_elasticsearch_index_mappings: {
	...
	close({
		...
		// (`properties`, `dynamic`, `_source`, `dynamic_templates`, `runtime`, etc.)
		// are supported. Only the keys and fields declared here are tracked; dynamic
		// extras added by Elasticsearch are ignored. Destroying this resource does not
