...
elasticstack_fleet_integration_policy: {
	...
	close({
		...
		// The ID of the output to send data to. When not specified, the default output
		// of the agent policy will be used.
		output_id?: string
		...
		// must match the space_ids of the referenced agent policy. Note: The order of
