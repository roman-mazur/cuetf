...
elasticstack_elasticsearch_ml_trained_model_alias: {
	...
	@jsonschema(id="https://github.com/roman-mazur/cuetf/schema/res/elasticstack_elasticsearch_ml_trained_model_alias")
	close({
		...
		// it is already assigned to a different model.
		reassign?: bool
	})
