...
#elasticstack_fleet_custom_integration: {
	@jsonschema(schema="https://json-schema.org/draft/2020-12/schema")
	@jsonschema(id="https://github.com/roman-mazur/cuetf/schema/res/elasticstack_fleet_custom_integration")
	close({
		...
		// The ID of this resource, derived from the package name and
		// version.
		id?: string
		...
		// The integration package name, populated from the upload
		// response.
		package_name?: string

		// Path to the local zip or tar.gz file containing the integration
		// package.
		package_path!: string
		...
		// installed. Changing this value forces resource replacement.
		space_id?: string
		timeouts?: close({
