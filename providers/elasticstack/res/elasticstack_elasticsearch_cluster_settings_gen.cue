package res
	...
	#persistent: close({
		setting?: matchN(1, [_#defs."/$defs/persistent/$defs/setting", [..._#defs."/$defs/persistent/$defs/setting"]])
	})

	#transient: close({
		setting?: matchN(1, [_#defs."/$defs/transient/$defs/setting", [..._#defs."/$defs/transient/$defs/setting"]])
	})
