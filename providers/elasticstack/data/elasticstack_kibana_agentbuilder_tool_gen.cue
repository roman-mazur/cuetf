...
elasticstack_kibana_agentbuilder_tool: {
	...
	close({
		...
		// When true, the workflow referenced by this tool will also be included. Only
		// valid when the tool type is `workflow`. Requires Kibana 9.4.0 or above.
		// Defaults to false.
		...
		// The YAML configuration of the referenced workflow. Only populated when
