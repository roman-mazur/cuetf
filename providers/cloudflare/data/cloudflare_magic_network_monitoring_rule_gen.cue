...
cloudflare_magic_network_monitoring_rule: {
	...
	close({
		...
		// The number of bits per second for the rule. When this value is exceeded for
		// the set duration, an alert notification is sent. Minimum of 1 and no
		// maximum.
		...
		// underscore (_), dash (-), period (.), and tilde (~). You can’t have a space
		// in the rule name. Max 256 characters.
		name?: string

		// The number of packets per second for the rule. When this value is exceeded
		// for the set duration, an alert notification is sent. Minimum of 1 and no
		// maximum.
