...
cloudflare_list: {
	...
	close({
		...
		// The items in the list. If set, this overwrites all items in the list. Do not
		// use with `cloudflare_list_item`.
		...
		// A search query to filter returned items. Its meaning depends on the list
		// type: IP addresses must start with the provided string, hostnames and bulk
