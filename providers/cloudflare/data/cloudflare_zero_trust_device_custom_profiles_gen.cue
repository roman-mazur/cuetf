...
cloudflare_zero_trust_device_custom_profiles: {
	...
	@jsonschema(id="https://github.com/roman-mazur/cuetf/schema/data/cloudflare_zero_trust_device_custom_profiles")
	close({
		account_id?: string
		...
		result?: matchN(1, [close({
			...
			// The amount of time in minutes a user is allowed access to their LAN. A value
			// of 0 will allow LAN access until the next WARP reconnection, such as a
			// reboot or a laptop waking from sleep. Note that this field is omitted from
