...
cloudflare_custom_hostnames: {
	...
	@jsonschema(id="https://github.com/roman-mazur/cuetf/schema/data/cloudflare_custom_hostnames")
	close({
		...
		hostname?: close({
			...
			// with the 'id', 'hostname', 'hostname.contain', or 'hostname.startsWith'
			// parameters.
			exact?: string

			// Filters hostnames by a prefix match on the hostname value. This parameter
			// cannot be used with the 'id', 'hostname', 'hostname.exact', or
		...
		// Available values: "active", "pending", "active_redeploying", "moved",
		// "pending_deletion", "deleted", "pending_blocked", "pending_migration",
		// "pending_provisioned", "test_pending", "test_active", "test_active_apex",
		// "test_blocked", "test_failed", "provisioned", "blocked".
		...
		result?: matchN(1, [close({
			...
			ssl?: close({
				...
				// Available values: "initializing", "pending_validation", "deleted",
				// "pending_issuance", "pending_deployment", "pending_deletion",
				// "pending_expiration", "expired", "active", "initializing_timed_out",
