...
#cloudflare_logpush_dataset_job: {
	...
	close({
		...
		output_options?: close({
			...
			// If set to true, subrequests will be merged into the parent
			// request. Only supported for the `http_requests` dataset.
			...
			// `unixnano`, `unix`, `rfc3339`, `rfc3339ms` or `rfc3339ns`.
			// Available values: "unixnano", "unix", "rfc3339", "rfc3339ms",
			// "rfc3339ns".
