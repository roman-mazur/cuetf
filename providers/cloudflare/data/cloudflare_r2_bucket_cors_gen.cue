...
cloudflare_r2_bucket_cors: {
	...
	@jsonschema(id="https://github.com/roman-mazur/cuetf/schema/data/cloudflare_r2_bucket_cors")
	close({
		// Account ID.
		account_id!: string
		...
		rules?: matchN(1, [close({
			...
			// JavaScript making the cross-origin request. If you need to access headers
			// beyond the safelisted response headers, such as Content-Encoding or
			// cf-cache-status, you must specify it here.
