...
cloudflare_hostname_tls_settings: {
	...
	@jsonschema(id="https://github.com/roman-mazur/cuetf/schema/data/cloudflare_hostname_tls_settings")
	close({
		...
		result?: matchN(1, [close({
			...
			// - `ciphers`: an array of allowed cipher suite strings in BoringSSL format
			// (e.g., `["ECDHE-RSA-AES128-GCM-SHA256", "AES128-GCM-SHA256"]`).
