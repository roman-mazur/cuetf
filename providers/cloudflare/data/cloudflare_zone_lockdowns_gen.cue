...
cloudflare_zone_lockdowns: {
	...
	@jsonschema(id="https://github.com/roman-mazur/cuetf/schema/data/cloudflare_zone_lockdowns")
	close({
		...
		result?: matchN(1, [close({
			...
			configurations?: matchN(1, [close({
				...
				// IP address in the Zone Lockdown rule.
			...
			// The URLs to include in the rule definition. You can use wildcards. Each
