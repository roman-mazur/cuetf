...
#Terraform: {
	...
	_#res: "\(#cloudflarePrefix)_ct_alerting": close({res.cloudflare_ct_alerting & cuetf.MetaArgs})
	...
	_#res: "\(#cloudflarePrefix)_email_security_allow_policy": close({res.cloudflare_email_security_allow_policy & cuetf.MetaArgs})
	_#res: "\(#cloudflarePrefix)_email_security_block_sender": close({res.cloudflare_email_security_block_sender & cuetf.MetaArgs})
	_#res: "\(#cloudflarePrefix)_email_security_domain": close({res.cloudflare_email_security_domain & cuetf.MetaArgs})
	...
	_#res: "\(#cloudflarePrefix)_nel_setting": close({res.cloudflare_nel_setting & cuetf.MetaArgs})
	...
	_#res: "\(#cloudflarePrefix)_precursor": close({res.cloudflare_precursor & cuetf.MetaArgs})
	...
	_#res: "\(#cloudflarePrefix)_zero_trust_resource_library_application": close({res.cloudflare_zero_trust_resource_library_application & cuetf.MetaArgs})
