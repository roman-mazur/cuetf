...
cloudflare_zero_trust_tunnel_cloudflared: {
	...
	@jsonschema(id="https://github.com/roman-mazur/cuetf/schema/res/cloudflare_zero_trust_tunnel_cloudflared")
	close({
		...
		// Sets the password required to run a locally-managed tunnel. Must be at least
		// 32 bytes and encoded as a base64 string.
