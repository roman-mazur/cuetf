...
cloudflare_universal_ssl_setting: {
	...
	close({
		...
		// domain unless you have uploaded a custom certificate or purchased an
		...
		//
		// If you do not have a valid custom or advanced certificate at Cloudflare's
		// edge and are unsure if any of the above Cloudflare settings are enabled, or
		// if any HTTP redirects exist at your origin, we advise leaving Universal SSL
