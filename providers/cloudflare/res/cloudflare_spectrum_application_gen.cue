...
cloudflare_spectrum_application: {
	...
	@jsonschema(id="https://github.com/roman-mazur/cuetf/schema/res/cloudflare_spectrum_application")
	close({
		...
		edge_ips?: close({
			...
			// The type of edge IP configuration specified. Dynamically allocated edge IPs
			// use Spectrum anycast IPs in accordance with the connectivity you specify.
		...
		// `"1000-2000"`.
		// Notes: If specifying a port range, the number of ports in the range must
		...
		// for implementation details on PROXY Protocol V1, PROXY Protocol V2, and
		...
		// Determines how data travels from the edge to your origin. When set to
		// "direct", Spectrum will send traffic directly to your origin, and the
