...
cloudflare_bot_management: {
	...
	close({
		...
		// Enable rule to block content bots. When enabled, blocks automated traffic
		// with low bot scores, excluding safe verified bot categories. Exceptions
		...
		// A read-only field that shows which unauthorized settings are currently active
		// on the zone. These settings typically result from upgrades or downgrades.
