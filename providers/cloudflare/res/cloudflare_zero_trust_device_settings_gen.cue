...
cloudflare_zero_trust_device_settings: {
	...
	@jsonschema(id="https://github.com/roman-mazur/cuetf/schema/res/cloudflare_zero_trust_device_settings")
	close({
		account_id!: string
		...
		// certificate for the external_emergency_signal_url. If provided, the WARP
		...
		// signal, formatted as a duration string (e.g., "5m", "2m30s", "1h"). Minimum
		// 30 seconds.
