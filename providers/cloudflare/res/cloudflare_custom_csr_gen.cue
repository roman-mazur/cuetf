...
#cloudflare_custom_csr: {
	...
	close({
		...
		// The common name (domain) for the CSR. Must be at most 64
		// characters.
		common_name!: string
		...
		// Key algorithm to use for the CSR. Defaults to rsa2048 if not
		// specified.
		...
		// Subject Alternative Names for the CSR. At least one SAN is
		// required.
		sans!: [...string]
