...
azurerm_container_app_environment: {
	...
	close({
		...
		// Environment to host infrastructure resources. **Note:** Only valid if a
		// `workload_profile` is specified. If `infrastructure_subnet_id` is specified,
		// this resource group will be created in the same subscription as
		// `infrastructure_subnet_id`.
		infrastructure_resource_group_name?: string

		// The existing Subnet to use for the Container Apps Control Plane. **NOTE:**
