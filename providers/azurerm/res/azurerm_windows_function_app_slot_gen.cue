...
azurerm_windows_function_app_slot: {
	...
	close({
		...
		// A comma separated list of possible outbound IP addresses as a string. For
		// example `52.23.25.3,52.143.43.12,52.143.43.17`. This is a superset of
	...
	#site_config: close({
		...
		// The number of minimum instances for this Windows Function App. Only affects
	...
	_#defs: "/$defs/site_config/$defs/application_stack": close({
		// The version of .Net. Possible values are `v3.0`, `v4.0`, `v6.0`, `v7.0`,
		// `v8.0`, `v9.0` and `v10.0`
