...
azurerm_linux_function_app: {
	...
	@jsonschema(id="https://github.com/roman-mazur/cuetf/schema/res/azurerm_linux_function_app")
	close({
		...
		// `WEBSITE_RUN_FROM_PACKAGE=1` or `SCM_DO_BUILD_DURING_DEPLOYMENT=true` to be
		// set on the App in `app_settings`.
	...
	#site_config: close({
		...
		// from the load balancer. Possible values are between `2` and `10`. Only valid
		// in conjunction with `health_check_path`
