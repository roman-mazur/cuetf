...
azurerm_container_app_environment_dapr_component: {
	...
	#metadata: close({
		...
		// The name of a secret specified in the `secrets` block that contains the value
		// for this metadata configuration item.
		secret_name?: string
