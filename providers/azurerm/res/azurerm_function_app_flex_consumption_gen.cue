...
azurerm_function_app_flex_consumption: {
	...
	@jsonschema(id="https://github.com/roman-mazur/cuetf/schema/res/azurerm_function_app_flex_consumption")
	close({
		...
		// The type of the storage container where the function app's code is hosted.
		...
		// Function App. **Note:** Using this value requires either
	...
	#site_config: close({
		...
		// site Possible values include: `1.0`, `1.1`, and `1.2`. Defaults to `1.2`.
