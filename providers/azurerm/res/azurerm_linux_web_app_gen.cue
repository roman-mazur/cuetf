...
azurerm_linux_web_app: {
	...
	@jsonschema(id="https://github.com/roman-mazur/cuetf/schema/res/azurerm_linux_web_app")
	close({
		...
		// Linux Web App. **Note:** Using this value requires either
	...
	_#defs: "/$defs/site_config/$defs/auto_heal_setting": close({
		action?: matchN(1, [_#defs."/$defs/site_config/$defs/auto_heal_setting/$defs/action", list.MaxItems(1) & [..._#defs."/$defs/site_config/$defs/auto_heal_setting/$defs/action"]])
		trigger?: matchN(1, [_#defs."/$defs/site_config/$defs/auto_heal_setting/$defs/trigger", list.MaxItems(1) & [..._#defs."/$defs/site_config/$defs/auto_heal_setting/$defs/trigger"]])
	})
