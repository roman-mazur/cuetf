...
#Terraform: {
	...
	_#res: "\(#azurermPrefix)_cdn_frontdoor_batch_rule_set": close({res.azurerm_cdn_frontdoor_batch_rule_set & cuetf.MetaArgs})
	...
	_#res: "\(#azurermPrefix)_cognitive_account_connection_account_key": close({res.azurerm_cognitive_account_connection_account_key & cuetf.MetaArgs})
	_#res: "\(#azurermPrefix)_cognitive_account_connection_account_managed_identity": close({res.azurerm_cognitive_account_connection_account_managed_identity & cuetf.MetaArgs})
	_#res: "\(#azurermPrefix)_cognitive_account_connection_api_key": close({res.azurerm_cognitive_account_connection_api_key & cuetf.MetaArgs})
	_#res: "\(#azurermPrefix)_cognitive_account_connection_custom_keys": close({res.azurerm_cognitive_account_connection_custom_keys & cuetf.MetaArgs})
	_#res: "\(#azurermPrefix)_cognitive_account_connection_entra_id": close({res.azurerm_cognitive_account_connection_entra_id & cuetf.MetaArgs})
	...
	_#res: "\(#azurermPrefix)_kubernetes_automatic_cluster": close({res.azurerm_kubernetes_automatic_cluster & cuetf.MetaArgs})
	...
	_#res: "\(#azurermPrefix)_log_analytics_workspace_table_microsoft": close({res.azurerm_log_analytics_workspace_table_microsoft & cuetf.MetaArgs})
	...
	_#res: "\(#azurermPrefix)_storage_account_table_properties": close({res.azurerm_storage_account_table_properties & cuetf.MetaArgs})
