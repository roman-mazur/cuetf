...
provider_schemas: "registry.terraform.io/scaleway/scaleway": {
		...
		scaleway_autoscaling_instance_policy: {
			...
			block: {
				attributes: {
					...
					value: {
						type:             "number"
						description:      "Value representing the magnitude of the scaling action to take for the Instance group. Depending on the `type` parameter, this number could represent a total number of Instances in the group, a number of Instances to add, or a percentage to scale the group by"
						description_kind: "plain"
						required:         true
					}
					zone: {
				...
				block_types: metric: {
					...
					block: {
						attributes: {
							...
							managed_metric: {
								type:             "string"
								description:      "Managed metric to use for this policy. These are available by default in Cockpit without any configuration or `node_exporter`. The chosen metric forms the basis of the condition that will be checked to determine whether a scaling action should be triggered"
								description_kind: "plain"
								optional:         true
							}
							name: {
						...
						block: {
							...
							block_types: {
								extension_eu: {
									nesting_mode: "list"
									block: {
										attributes: european_citizenship: {
											type:             "string"
		...
		scaleway_inference_model: {
			...
			block: {
				attributes: {
					...
					url: {
						type:             "string"
						description:      "The HTTPS URL to the model archive or repository. Typically, this is a Hugging Face repository URL (e.g., `https://huggingface.co/your-org/your-model`). The URL must be publicly accessible or require a valid secret for authentication."
						description_kind: "plain"
						required:         true
					}
				}
		...
		scaleway_key_manager_key: {
			...
			block: {
				attributes: {
					...
					rotated_at: {
						type:             "string"
						description:      "Key last rotation date."
						description_kind: "plain"
						computed:         true
					}
					rotation_count: {
						type:             "number"
						description:      "The rotation count tracks the number of times the key has been rotated."
						description_kind: "plain"
						computed:         true
					}
					state: {
					...
					updated_at: {
						type:             "string"
						description:      "Key last modification date."
						description_kind: "plain"
						computed:         true
					}
					usage: {
		...
		scaleway_secret: {
			...
			block: {
				attributes: {
					...
					type: {
						type:             "string"
						description:      "Type of the secret could be any value among: [unknown_type opaque certificate key_value basic_credentials database_credentials ssh_key]"
						description_kind: "plain"
						optional:         true
					}
					updated_at: {
			...
			block: {
				attributes: {
					...
					private_network: {
						type: ["set", ["object", {
							dhcp_config: "bool"
							ipam_ids: ["list", "string"]
							private_network_id: "string"
							static_config: ["list", "string"]
							status: "string"
							zone:   "string"
						}]]
						description:      "List of private network to connect with your load balancer"
				...
				attributes: {
					backends: {
						type: ["list", ["object", {
							...
							health_check_http: ["list", ["object", {
								code:        "number"
								host_header: "string"
								method:      "string"
								uri:         "string"
							}]]
							health_check_https: ["list", ["object", {
								code:        "number"
								host_header: "string"
								method:      "string"
								sni:         "string"
		...
		scaleway_secret_version: {
			...
			block: {
				attributes: {
					...
					region: {
						type:             "string"
						description:      "The region of the secret version. If not set, the region is derived from the secret_id when possible or from the provider configuration."
						description_kind: "plain"
						optional:         true
					}
					revision: {
	...
	action_schemas: {
		scaleway_apple_silicon_reboot_server: block: {
			attributes: {
				server_id: {
					type:             "string"
		...
		scaleway_baremetal_server_action: block: {
			attributes: {
				action: {
					type:             "string"
		...
		scaleway_block_export_snapshot: block: {
			attributes: {
				bucket: {
					type:             "string"
		...
		scaleway_cockpit_trigger_test_alert: block: {
			attributes: {
				project_id: {
					type:             "string"
		...
		scaleway_instance_create_snapshot: block: {
			attributes: {
				name: {
					type:             "string"
					description:      "Name of the snapshot"
		...
		scaleway_instance_export_snapshot: block: {
			attributes: {
				bucket: {
					type:             "string"
					description:      "Name of the bucket to export the snapshot to"
		...
		scaleway_instance_server_action: block: {
			attributes: {
				action: {
					type:             "string"
					description:      "Type of action to perform"
		...
		scaleway_job_definition_start: block: {
			attributes: {
				args: {
					type: ["list", "string"]
		...
		scaleway_key_manager_rotate_key: block: {
			attributes: {
				key_id: {
					type:             "string"
		...
		scaleway_mongodb_instance_snapshot: block: {
			attributes: {
				expires_at: {
					type:             "string"
		...
		scaleway_rdb_database_export_backup: block: {
			attributes: {
				backup_id: {
					type:             "string"
		...
		scaleway_rdb_database_restore_backup: block: {
			attributes: {
				backup_id: {
					type:             "string"
		...
		scaleway_rdb_instance_prepare_logs: block: {
			attributes: {
				end_date: {
					type:             "string"
		...
		scaleway_rdb_instance_purge_logs: block: {
			attributes: {
				instance_id: {
					type:             "string"
		...
		scaleway_rdb_instance_renew_certificate: block: {
			attributes: {
				instance_id: {
					type:             "string"
		...
		scaleway_rdb_instance_snapshot: block: {
			attributes: {
				expires_at: {
					type:             "string"
					description:      "Expiration date of the snapshot in RFC3339 format (ISO 8601). If not set, the snapshot will not expire."
		...
		scaleway_rdb_read_replica_promote: block: {
			attributes: {
				read_replica_id: {
					type:             "string"
		...
		scaleway_rdb_read_replica_reset: block: {
			attributes: {
				read_replica_id: {
					type:             "string"
		...
		scaleway_s2s_vpn_connection_disable_route_propagation: block: {
			attributes: {
				connection_id: {
					type:             "string"
		...
		scaleway_s2s_vpn_connection_enable_route_propagation: block: {
			attributes: {
				connection_id: {
					type:             "string"
		...
		scaleway_vpc_public_gateway_refresh_ssh_keys: block: {
			attributes: {
				gateway_id: {
					type:             "string"
