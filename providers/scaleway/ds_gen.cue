...
#Terraform: {
	...
	_#ds: "\(#scalewayPrefix)_annotations_binding": close({data.scaleway_annotations_binding & cuetf.MetaArgs})
	_#ds: "\(#scalewayPrefix)_annotations_key": close({data.scaleway_annotations_key & cuetf.MetaArgs})
	_#ds: "\(#scalewayPrefix)_annotations_value": close({data.scaleway_annotations_value & cuetf.MetaArgs})
