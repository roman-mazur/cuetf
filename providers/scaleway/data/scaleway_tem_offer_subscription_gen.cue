...
scaleway_tem_offer_subscription: {
	...
	close({
		...
		// Max number of custom blocklists that can be associated with the offer-subscription
		max_custom_blocklists_per_domain?: number

		// Max number of dedicated IPs that can be associated with the offer-subscription
