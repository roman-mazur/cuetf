...
scaleway_function: {
	...
	@jsonschema(id="https://github.com/roman-mazur/cuetf/schema/data/scaleway_function")
	close({
		...
		// Maximum replicas for your function (defaults to 20), our system will scale
		// your functions automatically based on incoming workload, but will never
		// scale the number of replicas above the configured max_scale.
		max_scale?: number

		// Memory limit in MB for your function, defaults to 256MB
		memory_limit?: number

		// Minimum replicas for your function, defaults to 0, Note that a function is
		// billed when it gets executed, and using a min_scale greater than 0 will
		// cause your function to run all the time.
		min_scale?: number
