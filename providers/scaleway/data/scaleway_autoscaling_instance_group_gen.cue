...
scaleway_autoscaling_instance_group: {
	...
	close({
		// The specification of the minimum and maximum replicas for the Instance group,
		// and the cooldown interval between two scaling events
		capacity?: [...close({
		...
		// Whether to delete all instances in this group when the group is destroyed.
		// Set to `true` to tear them down, `false` (the default) leaves them running
