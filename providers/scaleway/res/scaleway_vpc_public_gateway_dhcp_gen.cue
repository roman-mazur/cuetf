...
scaleway_vpc_public_gateway_dhcp: {
	...
	@jsonschema(id="https://github.com/roman-mazur/cuetf/schema/res/scaleway_vpc_public_gateway_dhcp")
	close({
		// The address of the DHCP server. This will be the gateway's address in the
		...
		// After how long, in seconds, a renew will be attempted. Must be 30s lower than
