...
scaleway_edge_services_waf_stage: {
	...
	@jsonschema(id="https://github.com/roman-mazur/cuetf/schema/res/scaleway_edge_services_waf_stage")
	close({
		...
		// The sensitivity level (`1`,`2`,`3`,`4`) to use when classifying requests as
