...
scaleway_container: {
	...
	close({
		...
		// Arguments passed to the command from the command "field". Overrides the
		// arguments from the container image.
		args?: [...string]
		...
		// If true, it will allow only HTTPS connections to access your container to
		// prevent it from being triggered by insecure connections (HTTP).
		https_connections_only?: bool
		id?:                     string

		// The image reference (e.g.
		// "rg.fr-par.scw.cloud/my-registry-namespace/image:tag" or "nginx:latest").
		image?: string
		...
		// Public URL of the container. This is the default endpoint generated by
		// Scaleway to access the container from the Internet.
		public_endpoint?: string

		// The region you want to attach the resource to
		region?: string

		// The sha256 of your source registry image, changing it will re-apply the
		// deployment. Can be any string
		...
		// The maximum amount of time in seconds during which your container can process
		// a request before we stop it. Defaults to 300s.
		timeout?: number
	})
