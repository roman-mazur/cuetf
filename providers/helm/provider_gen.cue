...
provider: {
	...
	close({
		...
		kubernetes?: close({
			...
			// Authentication info context of the kube config (name of the kubeconfig user,
			// --user flag in kubectl). Can be sourced from KUBE_CTX_AUTH_INFO.
			config_context_auth_info?: string

			// Cluster context of the kube config (name of the kubeconfig cluster, --cluster
			// flag in kubectl). Can be sourced from KUBE_CTX_CLUSTER.
		...
		// Queries per second used when communicating with the Kubernetes API. Can be
		// used to avoid throttling.
		qps?: number
